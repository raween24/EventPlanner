...
export type NotionV2DatabaseSearchParams = {
  resource: 'database';
  operation: 'search';
/**
...
export type NotionV2DatabaseSearchNode = {
  type: 'n8n-nodes-base.notion';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<NotionV2DatabaseSearchParams>;
  output?: Items<NotionV2DatabaseSearchOutput>;
};