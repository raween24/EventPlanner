...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      primaryKey: resolveSchema({ parameters, schema: z.union([z.literal('id'), z.literal('ncRecordId'), z.literal('custom'), expressionSchema]), required: false, displayOptions: {"show":{"version":[1,2,3]}}, defaults: {"version":1} }),
      customPrimaryKey: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"version":[1,2,3],"primaryKey":["custom"]}}, defaults: {"version":1,"primaryKey":"id"} }),
