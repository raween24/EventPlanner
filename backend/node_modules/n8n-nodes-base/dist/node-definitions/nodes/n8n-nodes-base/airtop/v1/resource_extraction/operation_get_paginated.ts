...
export type AirtopV1ExtractionGetPaginatedParams = {
  resource: 'extraction';
...
export type AirtopV1ExtractionGetPaginatedNode = {
  type: 'n8n-nodes-base.airtop';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<AirtopV1ExtractionGetPaginatedParams>;
  output?: Items<AirtopV1ExtractionGetPaginatedOutput>;
};