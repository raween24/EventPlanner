...
export type TelegramV1CallbackAnswerInlineQueryParams = {
  resource: 'callback';
...
export type TelegramV1CallbackAnswerInlineQueryNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1CallbackAnswerInlineQueryParams>;
};