...
/** Send a text message */
export type TelegramV11MessageSendMessageParams = {
  resource: 'message';
...
export type TelegramV11MessageSendMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendMessageParams>;
  output?: Items<TelegramV11MessageSendMessageOutput>;
};