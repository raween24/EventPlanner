...
/** Send a audio file */
export type TelegramV11MessageSendAudioParams = {
  resource: 'message';
  operation: 'sendAudio';
/**
...
export type TelegramV11MessageSendAudioNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendAudioParams>;
  output?: Items<TelegramV11MessageSendAudioOutput>;
};