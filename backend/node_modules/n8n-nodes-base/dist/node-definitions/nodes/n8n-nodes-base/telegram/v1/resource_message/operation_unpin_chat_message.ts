...
export type TelegramV1MessageUnpinChatMessageParams = {
  resource: 'message';
...
export type TelegramV1MessageUnpinChatMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageUnpinChatMessageParams>;
};