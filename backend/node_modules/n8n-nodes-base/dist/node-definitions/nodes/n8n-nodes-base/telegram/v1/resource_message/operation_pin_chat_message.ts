...
/** Pin a chat message */
export type TelegramV1MessagePinChatMessageParams = {
  resource: 'message';
...
export type TelegramV1MessagePinChatMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessagePinChatMessageParams>;
  output?: Items<TelegramV1MessagePinChatMessageOutput>;
};