...
/** Edit a text message */
export type TelegramV11MessageEditMessageTextParams = {
  resource: 'message';
...
export type TelegramV11MessageEditMessageTextNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageEditMessageTextParams>;
  output?: Items<TelegramV11MessageEditMessageTextOutput>;
};