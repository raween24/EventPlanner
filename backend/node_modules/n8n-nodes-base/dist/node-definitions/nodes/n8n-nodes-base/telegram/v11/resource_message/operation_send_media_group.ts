...
export type TelegramV11MessageSendMediaGroupParams = {
  resource: 'message';
...
export type TelegramV11MessageSendMediaGroupNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendMediaGroupParams>;
  output?: Items<TelegramV11MessageSendMediaGroupOutput>;
};