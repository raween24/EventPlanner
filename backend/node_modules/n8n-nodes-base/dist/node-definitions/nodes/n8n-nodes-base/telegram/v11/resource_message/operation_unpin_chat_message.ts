...
export type TelegramV11MessageUnpinChatMessageParams = {
  resource: 'message';
...
export type TelegramV11MessageUnpinChatMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageUnpinChatMessageParams>;
};