...
/** Edit a text message */
export type TelegramV1MessageEditMessageTextParams = {
  resource: 'message';
...
export type TelegramV1MessageEditMessageTextNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageEditMessageTextParams>;
  output?: Items<TelegramV1MessageEditMessageTextOutput>;
};