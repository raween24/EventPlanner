...
/** Send a document */
export type TelegramV1MessageSendDocumentParams = {
  resource: 'message';
...
export type TelegramV1MessageSendDocumentNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendDocumentParams>;
  output?: Items<TelegramV1MessageSendDocumentOutput>;
};