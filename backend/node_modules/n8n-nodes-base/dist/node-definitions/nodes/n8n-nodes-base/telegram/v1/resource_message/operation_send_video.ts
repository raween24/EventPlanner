...
/** Send a video */
export type TelegramV1MessageSendVideoParams = {
  resource: 'message';
  operation: 'sendVideo';
/**
...
export type TelegramV1MessageSendVideoNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendVideoParams>;
  output?: Items<TelegramV1MessageSendVideoOutput>;
};