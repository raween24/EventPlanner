...
export type TelegramV11MessageDeleteMessageParams = {
  resource: 'message';
...
export type TelegramV11MessageDeleteMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageDeleteMessageParams>;
  output?: Items<TelegramV11MessageDeleteMessageOutput>;
};