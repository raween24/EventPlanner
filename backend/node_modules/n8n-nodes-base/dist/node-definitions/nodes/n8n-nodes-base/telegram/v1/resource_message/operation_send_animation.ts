...
export type TelegramV1MessageSendAnimationParams = {
  resource: 'message';
...
export type TelegramV1MessageSendAnimationNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendAnimationParams>;
  output?: Items<TelegramV1MessageSendAnimationOutput>;
};