...
/** Send a location */
export type TelegramV11MessageSendLocationParams = {
  resource: 'message';
...
export type TelegramV11MessageSendLocationNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendLocationParams>;
  output?: Items<TelegramV11MessageSendLocationOutput>;
};