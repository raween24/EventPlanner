...
export type TelegramV11ChatAdministratorsParams = {
  resource: 'chat';
...
export type TelegramV11ChatAdministratorsNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11ChatAdministratorsParams>;
  output?: Items<TelegramV11ChatAdministratorsOutput>;
};