...
/** Send a audio file */
export type TelegramV1MessageSendAudioParams = {
  resource: 'message';
  operation: 'sendAudio';
/**
...
export type TelegramV1MessageSendAudioNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendAudioParams>;
  output?: Items<TelegramV1MessageSendAudioOutput>;
};