...
/** Send a chat action */
export type TelegramV1MessageSendChatActionParams = {
  resource: 'message';
...
export type TelegramV1MessageSendChatActionNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendChatActionParams>;
  output?: Items<TelegramV1MessageSendChatActionOutput>;
};