...
export type TelegramV11CallbackAnswerQueryParams = {
  resource: 'callback';
...
export type TelegramV11CallbackAnswerQueryNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11CallbackAnswerQueryParams>;
  output?: Items<TelegramV11CallbackAnswerQueryOutput>;
};