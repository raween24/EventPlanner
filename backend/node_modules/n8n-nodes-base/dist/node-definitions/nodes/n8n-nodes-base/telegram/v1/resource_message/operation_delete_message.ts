...
export type TelegramV1MessageDeleteMessageParams = {
  resource: 'message';
...
export type TelegramV1MessageDeleteMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageDeleteMessageParams>;
  output?: Items<TelegramV1MessageDeleteMessageOutput>;
};