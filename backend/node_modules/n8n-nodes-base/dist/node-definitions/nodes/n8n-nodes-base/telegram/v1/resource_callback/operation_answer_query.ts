...
export type TelegramV1CallbackAnswerQueryParams = {
  resource: 'callback';
...
export type TelegramV1CallbackAnswerQueryNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1CallbackAnswerQueryParams>;
  output?: Items<TelegramV1CallbackAnswerQueryOutput>;
};