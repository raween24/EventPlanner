...
export type TelegramV1MessageSendAndWaitParams = {
  resource: 'message';
...
export type TelegramV1MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendAndWaitParams>;
  output?: Items<TelegramV1MessageSendAndWaitOutput>;
};