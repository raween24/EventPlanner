...
/** Send a photo */
export type TelegramV1MessageSendPhotoParams = {
  resource: 'message';
  operation: 'sendPhoto';
/**
...
export type TelegramV1MessageSendPhotoNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendPhotoParams>;
  output?: Items<TelegramV1MessageSendPhotoOutput>;
};