...
export type TelegramV11MessageSendAnimationParams = {
  resource: 'message';
...
export type TelegramV11MessageSendAnimationNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendAnimationParams>;
  output?: Items<TelegramV11MessageSendAnimationOutput>;
};