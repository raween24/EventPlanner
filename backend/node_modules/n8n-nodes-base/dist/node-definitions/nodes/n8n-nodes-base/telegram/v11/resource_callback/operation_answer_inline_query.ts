...
export type TelegramV11CallbackAnswerInlineQueryParams = {
  resource: 'callback';
...
export type TelegramV11CallbackAnswerInlineQueryNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11CallbackAnswerInlineQueryParams>;
};