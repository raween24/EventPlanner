...
/** Send a document */
export type TelegramV11MessageSendDocumentParams = {
  resource: 'message';
...
export type TelegramV11MessageSendDocumentNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendDocumentParams>;
  output?: Items<TelegramV11MessageSendDocumentOutput>;
};