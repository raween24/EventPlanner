...
/** Send a sticker */
export type TelegramV11MessageSendStickerParams = {
  resource: 'message';
...
export type TelegramV11MessageSendStickerNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendStickerParams>;
  output?: Items<TelegramV11MessageSendStickerOutput>;
};