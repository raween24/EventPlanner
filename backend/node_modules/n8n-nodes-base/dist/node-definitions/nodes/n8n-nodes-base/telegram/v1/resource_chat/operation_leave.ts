...
export type TelegramV1ChatLeaveParams = {
  resource: 'chat';
  operation: 'leave';
/**
...
export type TelegramV1ChatLeaveNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1ChatLeaveParams>;
  output?: Items<TelegramV1ChatLeaveOutput>;
};