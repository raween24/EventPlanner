...
/** Send a photo */
export type TelegramV11MessageSendPhotoParams = {
  resource: 'message';
  operation: 'sendPhoto';
/**
...
export type TelegramV11MessageSendPhotoNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendPhotoParams>;
  output?: Items<TelegramV11MessageSendPhotoOutput>;
};