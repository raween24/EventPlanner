...
/** Pin a chat message */
export type TelegramV11MessagePinChatMessageParams = {
  resource: 'message';
...
export type TelegramV11MessagePinChatMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessagePinChatMessageParams>;
  output?: Items<TelegramV11MessagePinChatMessageOutput>;
};