...
export type TelegramV1MessageSendMediaGroupParams = {
  resource: 'message';
...
export type TelegramV1MessageSendMediaGroupNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendMediaGroupParams>;
  output?: Items<TelegramV1MessageSendMediaGroupOutput>;
};