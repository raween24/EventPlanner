...
/** Send a chat action */
export type TelegramV11MessageSendChatActionParams = {
  resource: 'message';
...
export type TelegramV11MessageSendChatActionNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendChatActionParams>;
  output?: Items<TelegramV11MessageSendChatActionOutput>;
};