...
export type TelegramV11ChatLeaveParams = {
  resource: 'chat';
  operation: 'leave';
/**
...
export type TelegramV11ChatLeaveNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11ChatLeaveParams>;
  output?: Items<TelegramV11ChatLeaveOutput>;
};