...
/** Send a video */
export type TelegramV11MessageSendVideoParams = {
  resource: 'message';
  operation: 'sendVideo';
/**
...
export type TelegramV11MessageSendVideoNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV11MessageSendVideoParams>;
  output?: Items<TelegramV11MessageSendVideoOutput>;
};