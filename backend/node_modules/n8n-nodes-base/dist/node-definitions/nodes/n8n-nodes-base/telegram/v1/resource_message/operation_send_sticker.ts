...
/** Send a sticker */
export type TelegramV1MessageSendStickerParams = {
  resource: 'message';
...
export type TelegramV1MessageSendStickerNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendStickerParams>;
  output?: Items<TelegramV1MessageSendStickerOutput>;
};