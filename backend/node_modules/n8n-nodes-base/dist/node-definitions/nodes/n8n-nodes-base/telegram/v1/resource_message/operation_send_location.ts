...
/** Send a location */
export type TelegramV1MessageSendLocationParams = {
  resource: 'message';
...
export type TelegramV1MessageSendLocationNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<TelegramV1MessageSendLocationParams>;
  output?: Items<TelegramV1MessageSendLocationOutput>;
};