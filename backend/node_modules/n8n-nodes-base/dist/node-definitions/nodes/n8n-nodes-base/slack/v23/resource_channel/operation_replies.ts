...
export type SlackV23ChannelRepliesParams = {
  resource: 'channel';
  operation: 'replies';
...
export type SlackV23ChannelRepliesNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ChannelRepliesParams>;
  output?: Items<SlackV23ChannelRepliesOutput>;
};