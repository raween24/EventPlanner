...
export type SlackV22ChannelHistoryParams = {
  resource: 'channel';
  operation: 'history';
...
export type SlackV22ChannelHistoryNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22ChannelHistoryParams>;
  output?: Items<SlackV22ChannelHistoryOutput>;
};