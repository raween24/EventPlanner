...
export type SlackV22UserUpdateProfileParams = {
  resource: 'user';
...
export type SlackV22UserUpdateProfileNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22UserUpdateProfileParams>;
  output?: Items<SlackV22UserUpdateProfileOutput>;
};