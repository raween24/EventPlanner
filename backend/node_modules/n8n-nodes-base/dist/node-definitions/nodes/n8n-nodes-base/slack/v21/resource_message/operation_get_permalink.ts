...
export type SlackV21MessageGetPermalinkParams = {
  resource: 'message';
...
export type SlackV21MessageGetPermalinkNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21MessageGetPermalinkParams>;
  output?: Items<SlackV21MessageGetPermalinkOutput>;
};