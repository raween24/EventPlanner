...
export type SlackV23UserGetProfileParams = {
  resource: 'user';
...
export type SlackV23UserGetProfileNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23UserGetProfileParams>;
  output?: Items<SlackV23UserGetProfileOutput>;
};