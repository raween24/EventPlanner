...
export type SlackV2UserUpdateProfileParams = {
  resource: 'user';
...
export type SlackV2UserUpdateProfileNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2UserUpdateProfileParams>;
  output?: Items<SlackV2UserUpdateProfileOutput>;
};