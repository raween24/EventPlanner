...
export type SlackV23UserUpdateProfileParams = {
  resource: 'user';
...
export type SlackV23UserUpdateProfileNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23UserUpdateProfileParams>;
  output?: Items<SlackV23UserUpdateProfileOutput>;
};