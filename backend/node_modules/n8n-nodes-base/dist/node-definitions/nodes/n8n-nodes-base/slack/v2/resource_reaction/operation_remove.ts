...
export type SlackV2ReactionRemoveParams = {
  resource: 'reaction';
  operation: 'remove';
...
export type SlackV2ReactionRemoveNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2ReactionRemoveParams>;
  output?: Items<SlackV2ReactionRemoveOutput>;
};