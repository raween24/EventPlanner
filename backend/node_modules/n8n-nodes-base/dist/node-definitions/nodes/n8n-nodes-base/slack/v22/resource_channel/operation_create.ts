...
export type SlackV22ChannelCreateParams = {
  resource: 'channel';
  operation: 'create';
...
export type SlackV22ChannelCreateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22ChannelCreateParams>;
  output?: Items<SlackV22ChannelCreateOutput>;
};