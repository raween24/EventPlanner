...
export type SlackV23MessagePostParams = {
  resource: 'message';
  operation: 'post';
...
export type SlackV23MessagePostNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23MessagePostParams>;
  output?: Items<SlackV23MessagePostOutput>;
};