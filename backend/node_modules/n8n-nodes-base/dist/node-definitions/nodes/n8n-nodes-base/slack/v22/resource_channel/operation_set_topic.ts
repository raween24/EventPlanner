...
export type SlackV22ChannelSetTopicParams = {
  resource: 'channel';
  operation: 'setTopic';
...
export type SlackV22ChannelSetTopicNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22ChannelSetTopicParams>;
  output?: Items<SlackV22ChannelSetTopicOutput>;
};