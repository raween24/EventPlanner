...
export type SlackV2ChannelHistoryParams = {
  resource: 'channel';
  operation: 'history';
...
export type SlackV2ChannelHistoryNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2ChannelHistoryParams>;
  output?: Items<SlackV2ChannelHistoryOutput>;
};