...
export type SlackV21MessagePostParams = {
  resource: 'message';
  operation: 'post';
...
export type SlackV21MessagePostNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21MessagePostParams>;
  output?: Items<SlackV21MessagePostOutput>;
};