...
export type SlackV21ChannelSetTopicParams = {
  resource: 'channel';
  operation: 'setTopic';
...
export type SlackV21ChannelSetTopicNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21ChannelSetTopicParams>;
  output?: Items<SlackV21ChannelSetTopicOutput>;
};