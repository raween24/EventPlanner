...
export type SlackV22MessageUpdateParams = {
  resource: 'message';
  operation: 'update';
...
export type SlackV22MessageUpdateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22MessageUpdateParams>;
  output?: Items<SlackV22MessageUpdateOutput>;
};