...
export type SlackV23ChannelGetAllParams = {
  resource: 'channel';
  operation: 'getAll';
...
export type SlackV23ChannelGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ChannelGetAllParams>;
  output?: Items<SlackV23ChannelGetAllOutput>;
};