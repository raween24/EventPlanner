...
export type SlackV23ChannelCreateParams = {
  resource: 'channel';
  operation: 'create';
...
export type SlackV23ChannelCreateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ChannelCreateParams>;
  output?: Items<SlackV23ChannelCreateOutput>;
};