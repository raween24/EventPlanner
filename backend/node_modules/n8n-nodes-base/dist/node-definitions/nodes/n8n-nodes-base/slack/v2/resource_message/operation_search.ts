...
export type SlackV2MessageSearchParams = {
  resource: 'message';
  operation: 'search';
...
export type SlackV2MessageSearchNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2MessageSearchParams>;
  output?: Items<SlackV2MessageSearchOutput>;
};