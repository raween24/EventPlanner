...
export type SlackV22MessageSendAndWaitParams = {
  resource: 'message';
...
export type SlackV22MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22MessageSendAndWaitParams>;
  output?: Items<SlackV22MessageSendAndWaitOutput>;
};