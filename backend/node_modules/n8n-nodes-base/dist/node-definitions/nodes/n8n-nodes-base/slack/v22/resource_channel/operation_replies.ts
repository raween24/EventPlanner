...
export type SlackV22ChannelRepliesParams = {
  resource: 'channel';
  operation: 'replies';
...
export type SlackV22ChannelRepliesNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22ChannelRepliesParams>;
  output?: Items<SlackV22ChannelRepliesOutput>;
};