...
export type SlackV22ChannelGetAllParams = {
  resource: 'channel';
  operation: 'getAll';
...
export type SlackV22ChannelGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22ChannelGetAllParams>;
  output?: Items<SlackV22ChannelGetAllOutput>;
};