...
export type SlackV23ReactionGetParams = {
  resource: 'reaction';
  operation: 'get';
...
export type SlackV23ReactionGetNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ReactionGetParams>;
  output?: Items<SlackV23ReactionGetOutput>;
};