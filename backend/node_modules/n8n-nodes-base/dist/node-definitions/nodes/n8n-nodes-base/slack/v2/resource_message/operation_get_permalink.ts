...
export type SlackV2MessageGetPermalinkParams = {
  resource: 'message';
...
export type SlackV2MessageGetPermalinkNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2MessageGetPermalinkParams>;
  output?: Items<SlackV2MessageGetPermalinkOutput>;
};