...
export type SlackV23ReactionRemoveParams = {
  resource: 'reaction';
  operation: 'remove';
...
export type SlackV23ReactionRemoveNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ReactionRemoveParams>;
  output?: Items<SlackV23ReactionRemoveOutput>;
};