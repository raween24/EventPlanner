...
export type SlackV22MessagePostParams = {
  resource: 'message';
  operation: 'post';
...
export type SlackV22MessagePostNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22MessagePostParams>;
  output?: Items<SlackV22MessagePostOutput>;
};