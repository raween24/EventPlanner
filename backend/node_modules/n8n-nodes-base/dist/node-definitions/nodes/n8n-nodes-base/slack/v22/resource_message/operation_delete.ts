...
export type SlackV22MessageDeleteParams = {
  resource: 'message';
  operation: 'delete';
...
export type SlackV22MessageDeleteNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22MessageDeleteParams>;
  output?: Items<SlackV22MessageDeleteOutput>;
};