...
export type SlackV23ChannelSetTopicParams = {
  resource: 'channel';
  operation: 'setTopic';
...
export type SlackV23ChannelSetTopicNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ChannelSetTopicParams>;
  output?: Items<SlackV23ChannelSetTopicOutput>;
};