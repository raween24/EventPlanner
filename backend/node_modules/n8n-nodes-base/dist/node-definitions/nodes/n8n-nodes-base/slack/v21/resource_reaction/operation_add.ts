...
export type SlackV21ReactionAddParams = {
  resource: 'reaction';
  operation: 'add';
...
export type SlackV21ReactionAddNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21ReactionAddParams>;
  output?: Items<SlackV21ReactionAddOutput>;
};