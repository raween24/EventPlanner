...
export type SlackV21ChannelGetAllParams = {
  resource: 'channel';
  operation: 'getAll';
...
export type SlackV21ChannelGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21ChannelGetAllParams>;
  output?: Items<SlackV21ChannelGetAllOutput>;
};