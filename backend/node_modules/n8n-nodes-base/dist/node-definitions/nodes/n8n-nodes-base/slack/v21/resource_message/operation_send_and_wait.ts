...
export type SlackV21MessageSendAndWaitParams = {
  resource: 'message';
...
export type SlackV21MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21MessageSendAndWaitParams>;
  output?: Items<SlackV21MessageSendAndWaitOutput>;
};