/**
 * Slack Node - Version 1 - Zod Schema Factory
...
const getUserProfileSchema = require('./resource_user_profile/index.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getUserProfileSchema({ ...helpers, parameters: effectiveParams }),
  ]);
};