...
export type SlackV2ChannelGetAllParams = {
  resource: 'channel';
  operation: 'getAll';
...
export type SlackV2ChannelGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2ChannelGetAllParams>;
  output?: Items<SlackV2ChannelGetAllOutput>;
};