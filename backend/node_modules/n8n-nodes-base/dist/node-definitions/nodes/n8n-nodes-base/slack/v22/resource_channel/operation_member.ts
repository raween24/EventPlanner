...
export type SlackV22ChannelMemberParams = {
  resource: 'channel';
  operation: 'member';
...
export type SlackV22ChannelMemberNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  credentials?: Credentials;
  config: NodeConfig<SlackV22ChannelMemberParams>;
  output?: Items<SlackV22ChannelMemberOutput>;
};