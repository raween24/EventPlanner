...
export type SlackV2MessageSendAndWaitParams = {
  resource: 'message';
...
export type SlackV2MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2MessageSendAndWaitParams>;
  output?: Items<SlackV2MessageSendAndWaitOutput>;
};