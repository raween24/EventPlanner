...
export type SlackV23ChannelOpenParams = {
  resource: 'channel';
  operation: 'open';
...
export type SlackV23ChannelOpenNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23ChannelOpenParams>;
  output?: Items<SlackV23ChannelOpenOutput>;
};