...
export type SlackV2ChannelRepliesParams = {
  resource: 'channel';
  operation: 'replies';
...
export type SlackV2ChannelRepliesNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2ChannelRepliesParams>;
  output?: Items<SlackV2ChannelRepliesOutput>;
};