...
export type SlackV21MessageUpdateParams = {
  resource: 'message';
  operation: 'update';
...
export type SlackV21MessageUpdateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<SlackV21MessageUpdateParams>;
  output?: Items<SlackV21MessageUpdateOutput>;
};