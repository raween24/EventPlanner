...
export type SlackV2ChannelMemberParams = {
  resource: 'channel';
  operation: 'member';
...
export type SlackV2ChannelMemberNode = {
  type: 'n8n-nodes-base.slack';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<SlackV2ChannelMemberParams>;
  output?: Items<SlackV2ChannelMemberOutput>;
};