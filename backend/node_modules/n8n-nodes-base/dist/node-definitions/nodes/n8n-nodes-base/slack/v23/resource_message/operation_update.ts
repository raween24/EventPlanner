...
export type SlackV23MessageUpdateParams = {
  resource: 'message';
  operation: 'update';
...
export type SlackV23MessageUpdateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  credentials?: Credentials;
  config: NodeConfig<SlackV23MessageUpdateParams>;
  output?: Items<SlackV23MessageUpdateOutput>;
};