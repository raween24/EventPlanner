...
export type MicrosoftExcelV2WorksheetReadRowsParams = {
  resource: 'worksheet';
  operation: 'readRows';
/**
 * Workbook
...
export type MicrosoftExcelV2WorksheetReadRowsNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV2WorksheetReadRowsParams>;
};