...
export type MicrosoftExcelV2WorksheetUpsertParams = {
  resource: 'worksheet';
  operation: 'upsert';
/**
 * Workbook
...
export type MicrosoftExcelV2WorksheetUpsertNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV2WorksheetUpsertParams>;
};