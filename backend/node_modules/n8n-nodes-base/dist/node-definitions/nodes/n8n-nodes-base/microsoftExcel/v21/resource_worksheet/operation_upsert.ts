...
export type MicrosoftExcelV21WorksheetUpsertParams = {
  resource: 'worksheet';
  operation: 'upsert';
/**
 * Workbook
...
export type MicrosoftExcelV21WorksheetUpsertNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV21WorksheetUpsertParams>;
};