...
export type MicrosoftExcelV2WorksheetAppendParams = {
  resource: 'worksheet';
  operation: 'append';
/**
 * Workbook
...
export type MicrosoftExcelV2WorksheetAppendNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV2WorksheetAppendParams>;
};