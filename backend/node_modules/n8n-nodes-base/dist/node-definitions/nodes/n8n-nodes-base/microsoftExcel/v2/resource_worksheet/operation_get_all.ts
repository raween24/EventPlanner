...
export type MicrosoftExcelV2WorksheetGetAllParams = {
  resource: 'worksheet';
  operation: 'getAll';
/**
 * Workbook
...
export type MicrosoftExcelV2WorksheetGetAllNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV2WorksheetGetAllParams>;
};