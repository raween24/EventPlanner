...
export type MicrosoftExcelV2TableConvertToRangeParams = {
  resource: 'table';
...
export type MicrosoftExcelV2TableConvertToRangeNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV2TableConvertToRangeParams>;
};