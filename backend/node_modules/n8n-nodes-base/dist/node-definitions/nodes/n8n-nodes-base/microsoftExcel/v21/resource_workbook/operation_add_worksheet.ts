...
export type MicrosoftExcelV21WorkbookAddWorksheetParams = {
  resource: 'workbook';
...
export type MicrosoftExcelV21WorkbookAddWorksheetNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV21WorkbookAddWorksheetParams>;
};