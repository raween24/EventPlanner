...
export type MicrosoftExcelV21TableGetColumnsParams = {
  resource: 'table';
...
export type MicrosoftExcelV21TableGetColumnsNode = {
  type: 'n8n-nodes-base.microsoftExcel';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftExcelV21TableGetColumnsParams>;
};