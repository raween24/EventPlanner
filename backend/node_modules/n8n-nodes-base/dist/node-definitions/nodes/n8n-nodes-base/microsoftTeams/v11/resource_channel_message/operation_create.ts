...
/** Create a channel */
export type MicrosoftTeamsV11ChannelMessageCreateParams = {
...
export type MicrosoftTeamsV11ChannelMessageCreateNode = {
  type: 'n8n-nodes-base.microsoftTeams';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<MicrosoftTeamsV11ChannelMessageCreateParams>;
};