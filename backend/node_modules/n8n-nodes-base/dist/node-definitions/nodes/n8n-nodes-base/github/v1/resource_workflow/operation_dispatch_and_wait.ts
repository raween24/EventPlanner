...
export type GithubV1WorkflowDispatchAndWaitParams = {
  resource: 'workflow';
...
export type GithubV1WorkflowDispatchAndWaitNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GithubV1WorkflowDispatchAndWaitParams>;
};