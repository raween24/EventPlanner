...
export type GithubV1RepositoryListReferrersParams = {
  resource: 'repository';
...
export type GithubV1RepositoryListReferrersNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GithubV1RepositoryListReferrersParams>;
};