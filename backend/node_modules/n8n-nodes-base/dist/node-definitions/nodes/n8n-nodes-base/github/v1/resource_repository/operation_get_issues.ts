...
export type GithubV1RepositoryGetIssuesParams = {
  resource: 'repository';
  operation: 'getIssues';
...
export type GithubV1RepositoryGetIssuesNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GithubV1RepositoryGetIssuesParams>;
  output?: Items<GithubV1RepositoryGetIssuesOutput>;
};