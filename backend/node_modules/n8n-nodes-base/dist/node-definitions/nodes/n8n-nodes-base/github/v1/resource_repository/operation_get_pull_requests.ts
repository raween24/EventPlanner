...
export type GithubV1RepositoryGetPullRequestsParams = {
  resource: 'repository';
...
export type GithubV1RepositoryGetPullRequestsNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GithubV1RepositoryGetPullRequestsParams>;
};