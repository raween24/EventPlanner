...
export type GithubV1ReleaseGetAllParams = {
  resource: 'release';
  operation: 'getAll';
...
export type GithubV1ReleaseGetAllNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GithubV1ReleaseGetAllParams>;
  output?: Items<GithubV1ReleaseGetAllOutput>;
};