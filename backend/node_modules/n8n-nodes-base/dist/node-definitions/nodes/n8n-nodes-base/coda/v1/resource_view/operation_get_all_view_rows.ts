...
export type CodaV1ViewGetAllViewRowsParams = {
  resource: 'view';
...
export type CodaV1ViewGetAllViewRowsNode = {
  type: 'n8n-nodes-base.coda';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<CodaV1ViewGetAllViewRowsParams>;
  output?: Items<CodaV1ViewGetAllViewRowsOutput>;
};