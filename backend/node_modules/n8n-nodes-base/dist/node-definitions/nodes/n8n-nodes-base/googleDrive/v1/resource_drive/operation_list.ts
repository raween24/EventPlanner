...
export type GoogleDriveV1DriveListParams = {
  resource: 'drive';
  operation: 'list';
/**
 * Authentication
 ...
 */
     ...
     * @displayOptions.show { /resource: ["file"], corpora: ["drive"] }
     */
...
export type GoogleDriveV1DriveListNode = {
  type: 'n8n-nodes-base.googleDrive';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleDriveV1DriveListParams>;
};