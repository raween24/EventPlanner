...
export type MongoDbV11DocumentFindOneAndUpdateParams = {
  resource: 'document';
...
export type MongoDbV11DocumentFindOneAndUpdateNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<MongoDbV11DocumentFindOneAndUpdateParams>;
};