...
export type MongoDbV11DocumentFindOneAndReplaceParams = {
  resource: 'document';
...
export type MongoDbV11DocumentFindOneAndReplaceNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<MongoDbV11DocumentFindOneAndReplaceParams>;
};