...
export type HighLevelV1TaskUpdateParams = {
  resource: 'task';
  operation: 'update';
/**
 ...
 */
     ...
     * @default incompleted
     */
    status?: 'incompleted' | 'completed' | Expression<string>;
    /** Title
     */
...
export type HighLevelV1TaskUpdateNode = {
  type: 'n8n-nodes-base.highLevel';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<HighLevelV1TaskUpdateParams>;
};