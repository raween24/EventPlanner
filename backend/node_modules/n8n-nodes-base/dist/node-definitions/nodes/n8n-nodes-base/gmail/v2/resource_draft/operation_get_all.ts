...
export type GmailV2DraftGetAllParams = {
  resource: 'draft';
  operation: 'getAll';
...
export type GmailV2DraftGetAllOutput = {
  date?: string;
  from?: {
    html?: string;
    text?: string;
...
export type GmailV2DraftGetAllNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<GmailV2DraftGetAllParams>;
  output?: Items<GmailV2DraftGetAllOutput>;
};