...
export type GmailV2DraftGetParams = {
  resource: 'draft';
  operation: 'get';
...
export type GmailV2DraftGetOutput = {
  date?: string;
  from?: {
    html?: string;
    text?: string;
...
export type GmailV2DraftGetNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<GmailV2DraftGetParams>;
  output?: Items<GmailV2DraftGetOutput>;
};