...
export type GmailV21ThreadReplyParams = {
  resource: 'thread';
  operation: 'reply';
...
export type GmailV21ThreadReplyOutput = {
  id?: string;
  labelIds?: Array<string>;
  threadId?: string;
};

export type GmailV21ThreadReplyNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<GmailV21ThreadReplyParams>;
  output?: Items<GmailV21ThreadReplyOutput>;
};