...
export type GmailV21MessageSendAndWaitParams = {
  resource: 'message';
...
export type GmailV21MessageSendAndWaitOutput = {
  data?: {
    approved?: boolean;
  };
};

export type GmailV21MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<GmailV21MessageSendAndWaitParams>;
  output?: Items<GmailV21MessageSendAndWaitOutput>;
};