...
export type GmailV2MessageGetAllParams = {
  resource: 'message';
  operation: 'getAll';
...
export type GmailV2MessageGetAllOutput = {
  date?: string;
  from?: {
    html?: string;
    text?: string;
...
export type GmailV2MessageGetAllNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<GmailV2MessageGetAllParams>;
  output?: Items<GmailV2MessageGetAllOutput>;
};