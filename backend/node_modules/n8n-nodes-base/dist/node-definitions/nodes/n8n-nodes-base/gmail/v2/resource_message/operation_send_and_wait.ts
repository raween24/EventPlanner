...
export type GmailV2MessageSendAndWaitParams = {
  resource: 'message';
...
export type GmailV2MessageSendAndWaitOutput = {
  data?: {
    approved?: boolean;
  };
};

export type GmailV2MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<GmailV2MessageSendAndWaitParams>;
  output?: Items<GmailV2MessageSendAndWaitOutput>;
};