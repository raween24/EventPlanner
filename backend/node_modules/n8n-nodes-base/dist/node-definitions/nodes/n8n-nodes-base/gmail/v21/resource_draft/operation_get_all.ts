...
export type GmailV21DraftGetAllParams = {
  resource: 'draft';
  operation: 'getAll';
...
export type GmailV21DraftGetAllOutput = {
  date?: string;
  from?: {
    html?: string;
    text?: string;
...
export type GmailV21DraftGetAllNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<GmailV21DraftGetAllParams>;
  output?: Items<GmailV21DraftGetAllOutput>;
};