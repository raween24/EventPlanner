...
export type GmailV2ThreadGetAllParams = {
  resource: 'thread';
  operation: 'getAll';
...
export type GmailV2ThreadGetAllOutput = {
  historyId?: string;
  id?: string;
  snippet?: string;
};

export type GmailV2ThreadGetAllNode = {
  type: 'n8n-nodes-base.gmail';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<GmailV2ThreadGetAllParams>;
  output?: Items<GmailV2ThreadGetAllOutput>;
};