...
/** Delete a document */
export type GoogleFirebaseCloudFirestoreV1DocumentDeleteParams = {
  resource: 'document';
  operation: 'delete';
...
export type GoogleFirebaseCloudFirestoreV1DocumentDeleteOutput = {
  success?: boolean;
};

export type GoogleFirebaseCloudFirestoreV1DocumentDeleteNode = {
  type: 'n8n-nodes-base.googleFirebaseCloudFirestore';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleFirebaseCloudFirestoreV1DocumentDeleteParams>;
  output?: Items<GoogleFirebaseCloudFirestoreV1DocumentDeleteOutput>;
};