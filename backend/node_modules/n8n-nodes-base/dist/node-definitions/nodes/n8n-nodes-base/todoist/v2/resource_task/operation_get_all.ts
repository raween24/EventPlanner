...
/** Task resource */
export type TodoistV2TaskGetAllParams = {
  resource: 'task';
  operation: 'getAll';
...
export type TodoistV2TaskGetAllNode = {
  type: 'n8n-nodes-base.todoist';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<TodoistV2TaskGetAllParams>;
  output?: Items<TodoistV2TaskGetAllOutput>;
};