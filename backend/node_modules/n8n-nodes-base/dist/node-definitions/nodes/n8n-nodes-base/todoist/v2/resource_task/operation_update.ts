...
/** Task resource */
export type TodoistV2TaskUpdateParams = {
  resource: 'task';
  operation: 'update';
...
export type TodoistV2TaskUpdateNode = {
  type: 'n8n-nodes-base.todoist';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<TodoistV2TaskUpdateParams>;
  output?: Items<TodoistV2TaskUpdateOutput>;
};