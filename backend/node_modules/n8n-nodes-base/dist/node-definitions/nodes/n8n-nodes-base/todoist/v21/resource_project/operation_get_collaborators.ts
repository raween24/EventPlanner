...
/** Project resource */
export type TodoistV21ProjectGetCollaboratorsParams = {
  resource: 'project';
...
export type TodoistV21ProjectGetCollaboratorsNode = {
  type: 'n8n-nodes-base.todoist';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<TodoistV21ProjectGetCollaboratorsParams>;
};