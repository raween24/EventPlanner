 ...
 * Discriminator: resource=deal, operation=getRecentlyModified
 */
...
export type HubspotV1DealGetRecentlyModifiedParams = {
  resource: 'deal';
...
export type HubspotV1DealGetRecentlyModifiedNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV1DealGetRecentlyModifiedParams>;
};