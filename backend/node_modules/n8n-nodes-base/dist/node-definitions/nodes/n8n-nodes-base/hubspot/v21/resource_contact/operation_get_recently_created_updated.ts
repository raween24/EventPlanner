...
export type HubspotV21ContactGetRecentlyCreatedUpdatedParams = {
  resource: 'contact';
...
export type HubspotV21ContactGetRecentlyCreatedUpdatedNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21ContactGetRecentlyCreatedUpdatedParams>;
  output?: Items<HubspotV21ContactGetRecentlyCreatedUpdatedOutput>;
};