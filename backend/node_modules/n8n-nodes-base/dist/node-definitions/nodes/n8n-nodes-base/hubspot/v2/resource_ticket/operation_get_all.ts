...
/** Get many contacts */
export type HubspotV2TicketGetAllParams = {
  resource: 'ticket';
  operation: 'getAll';
...
export type HubspotV2TicketGetAllNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2TicketGetAllParams>;
  output?: Items<HubspotV2TicketGetAllOutput>;
};