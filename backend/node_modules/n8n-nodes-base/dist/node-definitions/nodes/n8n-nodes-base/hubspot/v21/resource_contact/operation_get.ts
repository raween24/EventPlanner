...
/** Get a contact */
export type HubspotV21ContactGetParams = {
  resource: 'contact';
  operation: 'get';
...
export type HubspotV21ContactGetNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21ContactGetParams>;
  output?: Items<HubspotV21ContactGetOutput>;
};