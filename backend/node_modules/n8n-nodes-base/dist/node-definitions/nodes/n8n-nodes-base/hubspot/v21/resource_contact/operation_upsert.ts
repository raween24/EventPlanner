...
export type HubspotV21ContactUpsertParams = {
  resource: 'contact';
  operation: 'upsert';
...
export type HubspotV21ContactUpsertNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21ContactUpsertParams>;
  output?: Items<HubspotV21ContactUpsertOutput>;
};