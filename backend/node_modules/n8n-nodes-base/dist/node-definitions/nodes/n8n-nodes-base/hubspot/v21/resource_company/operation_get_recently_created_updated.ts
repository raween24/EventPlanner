...
export type HubspotV21CompanyGetRecentlyCreatedUpdatedParams = {
  resource: 'company';
...
export type HubspotV21CompanyGetRecentlyCreatedUpdatedNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21CompanyGetRecentlyCreatedUpdatedParams>;
};