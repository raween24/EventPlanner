...
/** Search contacts */
export type HubspotV2ContactSearchParams = {
  resource: 'contact';
  operation: 'search';
...
export type HubspotV2ContactSearchNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2ContactSearchParams>;
  output?: Items<HubspotV2ContactSearchOutput>;
};