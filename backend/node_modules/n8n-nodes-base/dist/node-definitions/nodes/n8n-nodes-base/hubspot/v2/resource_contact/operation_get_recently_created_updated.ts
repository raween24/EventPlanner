...
export type HubspotV2ContactGetRecentlyCreatedUpdatedParams = {
  resource: 'contact';
...
export type HubspotV2ContactGetRecentlyCreatedUpdatedNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2ContactGetRecentlyCreatedUpdatedParams>;
  output?: Items<HubspotV2ContactGetRecentlyCreatedUpdatedOutput>;
};