...
/** Update a company */
export type HubspotV2CompanyUpdateParams = {
  resource: 'company';
  operation: 'update';
...
export type HubspotV2CompanyUpdateNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2CompanyUpdateParams>;
  output?: Items<HubspotV2CompanyUpdateOutput>;
};