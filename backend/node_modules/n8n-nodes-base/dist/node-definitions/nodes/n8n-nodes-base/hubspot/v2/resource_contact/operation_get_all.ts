...
/** Get many contacts */
export type HubspotV2ContactGetAllParams = {
  resource: 'contact';
  operation: 'getAll';
...
export type HubspotV2ContactGetAllNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2ContactGetAllParams>;
  output?: Items<HubspotV2ContactGetAllOutput>;
};