...
/** Get a contact */
export type HubspotV2ContactGetParams = {
  resource: 'contact';
  operation: 'get';
...
export type HubspotV2ContactGetNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2ContactGetParams>;
  output?: Items<HubspotV2ContactGetOutput>;
};