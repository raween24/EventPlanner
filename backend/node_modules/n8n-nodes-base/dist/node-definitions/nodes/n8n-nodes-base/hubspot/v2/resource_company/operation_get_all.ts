...
/** Get many contacts */
export type HubspotV2CompanyGetAllParams = {
  resource: 'company';
  operation: 'getAll';
...
export type HubspotV2CompanyGetAllNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2CompanyGetAllParams>;
  output?: Items<HubspotV2CompanyGetAllOutput>;
};