...
export type HubspotV2CompanySearchByDomainParams = {
  resource: 'company';
...
export type HubspotV2CompanySearchByDomainNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2CompanySearchByDomainParams>;
  output?: Items<HubspotV2CompanySearchByDomainOutput>;
};