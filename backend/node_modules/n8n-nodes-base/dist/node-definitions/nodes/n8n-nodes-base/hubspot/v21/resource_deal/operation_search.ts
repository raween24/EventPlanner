...
/** Search contacts */
export type HubspotV21DealSearchParams = {
  resource: 'deal';
  operation: 'search';
...
export type HubspotV21DealSearchNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21DealSearchParams>;
  output?: Items<HubspotV21DealSearchOutput>;
};