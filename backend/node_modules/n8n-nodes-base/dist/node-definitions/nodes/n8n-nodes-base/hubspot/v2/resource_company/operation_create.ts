...
/** Create a company */
export type HubspotV2CompanyCreateParams = {
  resource: 'company';
  operation: 'create';
...
export type HubspotV2CompanyCreateNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2CompanyCreateParams>;
  output?: Items<HubspotV2CompanyCreateOutput>;
};