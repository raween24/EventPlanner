...
/** Get a contact */
export type HubspotV21TicketGetParams = {
  resource: 'ticket';
  operation: 'get';
...
export type HubspotV21TicketGetNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21TicketGetParams>;
  output?: Items<HubspotV21TicketGetOutput>;
};