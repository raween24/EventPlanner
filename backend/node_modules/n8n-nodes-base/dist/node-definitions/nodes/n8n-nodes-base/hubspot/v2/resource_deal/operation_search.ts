...
/** Search contacts */
export type HubspotV2DealSearchParams = {
  resource: 'deal';
  operation: 'search';
...
export type HubspotV2DealSearchNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2DealSearchParams>;
  output?: Items<HubspotV2DealSearchOutput>;
};