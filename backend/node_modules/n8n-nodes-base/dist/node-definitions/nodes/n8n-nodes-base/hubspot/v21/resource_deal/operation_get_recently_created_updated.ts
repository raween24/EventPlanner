...
export type HubspotV21DealGetRecentlyCreatedUpdatedParams = {
  resource: 'deal';
...
export type HubspotV21DealGetRecentlyCreatedUpdatedNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21DealGetRecentlyCreatedUpdatedParams>;
};