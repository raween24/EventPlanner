...
export type HubspotV2DealGetRecentlyCreatedUpdatedParams = {
  resource: 'deal';
...
export type HubspotV2DealGetRecentlyCreatedUpdatedNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<HubspotV2DealGetRecentlyCreatedUpdatedParams>;
};