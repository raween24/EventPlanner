...
/** Get many contacts */
export type HubspotV21DealGetAllParams = {
  resource: 'deal';
  operation: 'getAll';
...
export type HubspotV21DealGetAllNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21DealGetAllParams>;
  output?: Items<HubspotV21DealGetAllOutput>;
};