...
/** Get many contacts */
export type HubspotV21TicketGetAllParams = {
  resource: 'ticket';
  operation: 'getAll';
...
export type HubspotV21TicketGetAllNode = {
  type: 'n8n-nodes-base.hubspot';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<HubspotV21TicketGetAllParams>;
  output?: Items<HubspotV21TicketGetAllOutput>;
};