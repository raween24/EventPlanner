...
export type WhatsAppV1MessageSendAndWaitParams = {
  resource: 'message';
...
export type WhatsAppV1MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.whatsApp';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<WhatsAppV1MessageSendAndWaitParams>;
  output?: Items<WhatsAppV1MessageSendAndWaitOutput>;
};