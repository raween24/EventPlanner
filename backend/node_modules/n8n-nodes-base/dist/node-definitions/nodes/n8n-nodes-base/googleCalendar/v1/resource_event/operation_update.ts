...
/** Update an event */
export type GoogleCalendarV1EventUpdateParams = {
  resource: 'event';
  operation: 'update';
/**
...
export type GoogleCalendarV1EventUpdateOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV1EventUpdateNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV1EventUpdateParams>;
  output?: Items<GoogleCalendarV1EventUpdateOutput>;
};