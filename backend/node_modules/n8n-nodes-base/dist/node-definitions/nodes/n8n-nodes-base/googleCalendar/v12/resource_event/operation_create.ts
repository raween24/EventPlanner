...
export type GoogleCalendarV12EventCreateParams = {
  resource: 'event';
  operation: 'create';
/**
...
export type GoogleCalendarV12EventCreateOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV12EventCreateNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV12EventCreateParams>;
  output?: Items<GoogleCalendarV12EventCreateOutput>;
};