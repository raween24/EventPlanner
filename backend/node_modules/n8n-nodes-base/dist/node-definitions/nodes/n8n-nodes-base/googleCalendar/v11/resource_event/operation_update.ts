...
/** Update an event */
export type GoogleCalendarV11EventUpdateParams = {
  resource: 'event';
  operation: 'update';
/**
...
export type GoogleCalendarV11EventUpdateOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV11EventUpdateNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV11EventUpdateParams>;
  output?: Items<GoogleCalendarV11EventUpdateOutput>;
};