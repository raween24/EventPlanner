...
export type GoogleCalendarV12EventGetAllParams = {
  resource: 'event';
  operation: 'getAll';
/**
...
export type GoogleCalendarV12EventGetAllOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV12EventGetAllNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV12EventGetAllParams>;
  output?: Items<GoogleCalendarV12EventGetAllOutput>;
};