...
/** Retrieve an event */
export type GoogleCalendarV1EventGetParams = {
  resource: 'event';
  operation: 'get';
/**
...
export type GoogleCalendarV1EventGetOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV1EventGetNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV1EventGetParams>;
  output?: Items<GoogleCalendarV1EventGetOutput>;
};