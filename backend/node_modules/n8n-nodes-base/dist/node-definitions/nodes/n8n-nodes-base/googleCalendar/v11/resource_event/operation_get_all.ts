...
export type GoogleCalendarV11EventGetAllParams = {
  resource: 'event';
  operation: 'getAll';
/**
...
export type GoogleCalendarV11EventGetAllOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV11EventGetAllNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV11EventGetAllParams>;
  output?: Items<GoogleCalendarV11EventGetAllOutput>;
};