...
export type GoogleCalendarV1EventGetAllParams = {
  resource: 'event';
  operation: 'getAll';
/**
...
export type GoogleCalendarV1EventGetAllOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV1EventGetAllNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV1EventGetAllParams>;
  output?: Items<GoogleCalendarV1EventGetAllOutput>;
};