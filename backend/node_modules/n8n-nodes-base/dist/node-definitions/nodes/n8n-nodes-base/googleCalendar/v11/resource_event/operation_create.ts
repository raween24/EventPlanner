...
export type GoogleCalendarV11EventCreateParams = {
  resource: 'event';
  operation: 'create';
/**
...
export type GoogleCalendarV11EventCreateOutput = {
  created?: string;
  creator?: {
    email?: string;
    self?: boolean;
...
export type GoogleCalendarV11EventCreateNode = {
  type: 'n8n-nodes-base.googleCalendar';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<GoogleCalendarV11EventCreateParams>;
  output?: Items<GoogleCalendarV11EventCreateOutput>;
};