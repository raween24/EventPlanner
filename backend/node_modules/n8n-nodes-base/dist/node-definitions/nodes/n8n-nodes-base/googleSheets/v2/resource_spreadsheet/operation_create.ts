...
/** Create a new sheet */
export type GoogleSheetsV2SpreadsheetCreateParams = {
...
export type GoogleSheetsV2SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV2SpreadsheetCreateParams>;
};