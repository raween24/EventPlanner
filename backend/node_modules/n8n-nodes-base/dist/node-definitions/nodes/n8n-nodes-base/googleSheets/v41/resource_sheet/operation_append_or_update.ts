...
export type GoogleSheetsV41SheetAppendOrUpdateParams = {
  resource: 'sheet';
...
export type GoogleSheetsV41SheetAppendOrUpdateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.1;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV41SheetAppendOrUpdateParams>;
};