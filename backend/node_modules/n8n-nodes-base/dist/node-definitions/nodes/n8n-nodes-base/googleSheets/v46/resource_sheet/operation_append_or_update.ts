...
export type GoogleSheetsV46SheetAppendOrUpdateParams = {
  resource: 'sheet';
...
export type GoogleSheetsV46SheetAppendOrUpdateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.6;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV46SheetAppendOrUpdateParams>;
};