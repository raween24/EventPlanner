...
export type GoogleSheetsV43SheetAppendOrUpdateParams = {
  resource: 'sheet';
...
export type GoogleSheetsV43SheetAppendOrUpdateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.3;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV43SheetAppendOrUpdateParams>;
};