...
/** Create a new sheet */
export type GoogleSheetsV44SpreadsheetCreateParams = {
...
export type GoogleSheetsV44SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.4;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV44SpreadsheetCreateParams>;
};