 ...
 * Discriminator: resource=sheet, operation=upsert
 */
...
export type GoogleSheetsV1SheetUpsertParams = {
  resource: 'sheet';
  operation: 'upsert';
/**
 * Authentication
...
export type GoogleSheetsV1SheetUpsertNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV1SheetUpsertParams>;
};