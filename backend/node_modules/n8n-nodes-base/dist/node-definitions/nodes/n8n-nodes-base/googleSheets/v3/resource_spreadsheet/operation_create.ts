...
/** Create a new sheet */
export type GoogleSheetsV3SpreadsheetCreateParams = {
...
export type GoogleSheetsV3SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 3;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV3SpreadsheetCreateParams>;
};