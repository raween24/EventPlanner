...
/** Create a new sheet */
export type GoogleSheetsV45SpreadsheetCreateParams = {
...
export type GoogleSheetsV45SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.5;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV45SpreadsheetCreateParams>;
};