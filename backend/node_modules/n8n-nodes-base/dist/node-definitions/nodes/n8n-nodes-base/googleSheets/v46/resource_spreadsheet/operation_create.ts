...
/** Create a new sheet */
export type GoogleSheetsV46SpreadsheetCreateParams = {
...
export type GoogleSheetsV46SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.6;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV46SpreadsheetCreateParams>;
};