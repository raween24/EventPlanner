...
/** Create a new sheet */
export type GoogleSheetsV4SpreadsheetCreateParams = {
...
export type GoogleSheetsV4SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV4SpreadsheetCreateParams>;
};