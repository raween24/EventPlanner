...
export type GoogleSheetsV45SheetAppendOrUpdateParams = {
  resource: 'sheet';
...
export type GoogleSheetsV45SheetAppendOrUpdateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.5;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV45SheetAppendOrUpdateParams>;
};