...
export type GoogleSheetsV42SheetAppendOrUpdateParams = {
  resource: 'sheet';
...
export type GoogleSheetsV42SheetAppendOrUpdateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.2;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV42SheetAppendOrUpdateParams>;
};