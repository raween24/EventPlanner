...
export type GoogleSheetsV4SheetAppendOrUpdateParams = {
  resource: 'sheet';
...
export type GoogleSheetsV4SheetAppendOrUpdateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV4SheetAppendOrUpdateParams>;
};