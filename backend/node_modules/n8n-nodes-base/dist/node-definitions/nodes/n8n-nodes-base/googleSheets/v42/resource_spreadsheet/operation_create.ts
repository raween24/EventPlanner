...
/** Create a new sheet */
export type GoogleSheetsV42SpreadsheetCreateParams = {
...
export type GoogleSheetsV42SpreadsheetCreateNode = {
  type: 'n8n-nodes-base.googleSheets';
  version: 4.2;
  credentials?: Credentials;
  config: NodeConfig<GoogleSheetsV42SpreadsheetCreateParams>;
};