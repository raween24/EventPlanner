...
async function getPodIdentityCredentials() {
    ...
    try {
        ...
        const authTokenFile = (0, exports.envGetter)('AWS_CONTAINER_AUTHORIZATION_TOKEN_FILE');
        if (authTokenFile) {
            try {
                authToken = (await (0, promises_1.readFile)(authTokenFile, 'utf-8')).trim();
            }
            catch (error) {
        ...
        if (!authToken) {
            authToken = (0, exports.envGetter)('AWS_CONTAINER_AUTHORIZATION_TOKEN');
        }
        const headers = {
            'User-Agent': 'n8n-aws-credential',
        };
