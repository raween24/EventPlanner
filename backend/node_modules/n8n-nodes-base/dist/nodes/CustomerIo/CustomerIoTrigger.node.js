    ...
    webhookMethods = {
        default: {
            async checkExists() {
                ...
                let { reporting_webhooks: webhooks } = await GenericFunctions_1.customerIoApiRequest.call(this, 'GET', endpoint, {}, 'app');
                if (webhooks === null) {
                    webhooks = [];
                }
            ...
            async create() {
                ...
                const body = {
                    ...
                    endpoint: webhookUrl,
                    events: events.map(GenericFunctions_1.toApiEventName),
                };
                const webhook = await GenericFunctions_1.customerIoApiRequest.call(this, 'POST', endpoint, body, 'app');
                const webhookData = this.getWorkflowStaticData('node');
                webhookData.webhookId = webhook.id;
                return true;
            },
            async delete() {
                ...
                if (webhookData.webhookId !== undefined) {
                    ...
                    try {
                        await GenericFunctions_1.customerIoApiRequest.call(this, 'DELETE', endpoint, {}, 'app');
                    }
                    catch (error) {
                        return false;
                    }
