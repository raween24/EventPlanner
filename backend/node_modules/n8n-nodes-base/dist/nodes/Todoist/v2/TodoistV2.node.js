    ...
    methods = {
        listSearch: {
            async searchProjects(filter) {
                const projects = await (0, GenericFunctions_1.todoistApiGetAllRequest)(this, '/projects');
                return {
                    results: projects
        ...
        loadOptions: {
            ...
            async getSections() {
                ...
                if (projectId) {
                    ...
                    const sections = await (0, GenericFunctions_1.todoistApiGetAllRequest)(this, '/sections', qs);
            ...
            async getItems() {
                ...
                if (projectId) {
                    ...
                    const items = await (0, GenericFunctions_1.todoistApiGetAllRequest)(this, '/tasks', qs);
            ...
            async getLabels() {
                const returnData = [];
                const labels = await (0, GenericFunctions_1.todoistApiGetAllRequest)(this, '/labels');
