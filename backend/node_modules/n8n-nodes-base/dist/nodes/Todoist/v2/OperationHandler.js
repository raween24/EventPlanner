...
class GetAllHandler {
    async handleOperation(ctx, itemIndex) {
        ...
        const data = await (0, GenericFunctions_1.todoistApiGetAllRequest)(ctx, endpoint, qs, limit);
        return { data };
    }
}
...
class ProjectGetAllHandler {
    async handleOperation(ctx, _itemIndex) {
        const data = await (0, GenericFunctions_1.todoistApiGetAllRequest)(ctx, '/projects');
        return { data };
    }
}
...
class ProjectGetCollaboratorsHandler {
    async handleOperation(ctx, itemIndex) {
        const id = ctx.getNodeParameter('projectId', itemIndex);
        assertValidTodoistId('projectId', id, ctx.getNode());
        const data = await (0, GenericFunctions_1.todoistApiGetAllRequest)(ctx, `/projects/${id}/collaborators`);
        return { data };
    }
}
...
class SectionGetAllHandler {
    async handleOperation(ctx, itemIndex) {
        ...
        const data = await (0, GenericFunctions_1.todoistApiGetAllRequest)(ctx, '/sections', qs);
        return { data };
    }
}
...
class CommentGetAllHandler {
    async handleOperation(ctx, itemIndex) {
        ...
        const data = await (0, GenericFunctions_1.todoistApiGetAllRequest)(ctx, '/comments', qs);
        return { data };
    }
}
...
class LabelGetAllHandler {
    async handleOperation(ctx, _itemIndex) {
        const data = await (0, GenericFunctions_1.todoistApiGetAllRequest)(ctx, '/labels');
        return { data };
    }
}
