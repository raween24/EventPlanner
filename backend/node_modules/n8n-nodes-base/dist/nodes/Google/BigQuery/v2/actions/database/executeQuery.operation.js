...
async function execute() {
    ...
    for (let i = 0; i < length; i++) {
        try {
            ...
            const response = await transport_1.googleBigQueryApiRequest.call(this, 'POST', `/v2/projects/${projectId}/jobs`, {
                configuration: {
                    query: body,
                },
            });
            ...
            if (response.status?.state === 'DONE') {
                ...
                const queryResponse = await transport_1.googleBigQueryApiRequestAllItems.call(this, 'GET', `/v2/projects/${projectId}/queries/${jobId}`, undefined, qs);
    ...
    outerLoop: while (jobs.length > 0) {
        ...
        for (const job of jobs) {
            ...
            try {
                ...
                //https://cloud.google.com/bigquery/docs/reference/rest/v2/jobs/getQueryResults
                const response = await transport_1.googleBigQueryApiRequestAllItems.call(this, 'GET', `/v2/projects/${job.projectId}/queries/${job.jobId}`, undefined, qs);
