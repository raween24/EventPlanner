...
const descriptionV2 = {
    ...
    properties: [
        ...
        { ...common_descriptions_1.formFields, displayOptions: { show: { '@version': [{ _cnd: { lt: 2.5 } }] } } },
        { ...common_descriptions_1.formFieldsDynamic, displayOptions: { show: { '@version': [{ _cnd: { gte: 2.5 } }] } } },
        ...
        },
        {
            ...
            options: [
                ...
                common_descriptions_1.ipAllowlist,
                {
