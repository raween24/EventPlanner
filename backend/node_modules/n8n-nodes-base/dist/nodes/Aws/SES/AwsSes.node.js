                ...
                if (resource === 'template') {
                    if (operation === 'create') {
                        ...
                        if (additionalFields.textPart) {
                            params.push(`Template.TextPart=${encodeURIComponent(additionalFields.textPart)}`);
                        }
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.textPart) {
                            params.push(`Template.TextPart=${encodeURIComponent(updateFields.textPart)}`);
                        }
                        if (updateFields.subjectPart) {
                            params.push(`Template.SubjectPart=${encodeURIComponent(updateFields.subjectPart)}`);
                        }
                        if (updateFields.subjectPart) {
                            params.push(`Template.HtmlPart=${encodeURIComponent(updateFields.htmlPart)}`);
                        }
