...
export declare function prepareMultiPartForm(this: IExecuteFunctions, files: IDataObject[], jsonPayload: IDataObject, i: number): Promise<FormData>;
...
export declare function sendDiscordMessage(this: IExecuteFunctions, { guildId, userGuilds, isOAuth2, body, files, itemIndex, }: {
    guildId: string;
