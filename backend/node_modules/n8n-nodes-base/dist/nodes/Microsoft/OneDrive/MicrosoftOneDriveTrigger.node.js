...
class MicrosoftOneDriveTrigger {
    ...
    async poll() {
        ...
        const lastLink = workflowData.LastLink || `${baseUrl}/v1.0/me/drive/root/delta?token=latest`;
        ...
        try {
            if (this.getMode() === 'manual') {
                responseData = (await GenericFunctions_1.microsoftApiRequest.call(this, 'GET', '', {}, {}, `${baseUrl}/v1.0/me/drive/root/delta`)).value;
            }
            else {
