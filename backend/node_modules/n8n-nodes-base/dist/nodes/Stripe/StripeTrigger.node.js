...
const StripeTriggerHelpers_1 = require("./StripeTriggerHelpers");
class StripeTrigger {
    description = {
    ...
    webhookMethods = {
        default: {
            ...
            async create() {
                ...
                const responseData = await helpers_1.stripeApiRequest.call(this, 'POST', endpoint, body);
    ...
    async webhook() {
        ...
        if (!(await StripeTriggerHelpers_1.verifySignature.call(this))) {
