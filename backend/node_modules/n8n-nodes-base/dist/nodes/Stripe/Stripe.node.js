...
class Stripe {
    description = {
        ...
        properties: [
            ...
            ...descriptions_1.meterEventOperations,
            ...descriptions_1.meterEventFields,
                    ...
                    if (operation === 'create') {
                        ...
                        if (!(0, isEmpty_1.default)(additionalFields)) {
                            ...
                            if (additionalFields.timestamp) {
                                ...
                                const timestamp = new Date(additionalFields.timestamp).getTime() / 1000;
                                body.timestamp = Math.floor(timestamp);
                            }
                            if (additionalFields.customPayload) {
                                const customPayloadData = additionalFields.customPayload;
                        ...
                        responseData = await helpers_1.stripeApiRequest.call(this, 'POST', '/billing/meter_events', body, {});
                    }
                }
            }
            catch (error) {
