...
async function execute(runQueries, items, nodeOptions, db, pgp) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            if (nodeVersion >= 2.4) {
                item = (0, utils_1.convertArraysToPostgresFormat)(item, tableSchema, this.getNode(), i);
            }
    ...
    return await (0, utils_1.runQueriesAndHandleErrors)(runQueries, queries, nodeOptions, errorItemsMap);
}
