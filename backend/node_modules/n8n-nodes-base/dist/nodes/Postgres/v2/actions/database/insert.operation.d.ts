...
import type { PgpClient, PgpDatabase, PostgresNodeOptions, QueriesRunner } from '../../helpers/interfaces';
...
export declare function execute(this: IExecuteFunctions, runQueries: QueriesRunner, items: INodeExecutionData[], nodeOptions: PostgresNodeOptions, db: PgpDatabase, pgp: PgpClient): Promise<INodeExecutionData[]>;
