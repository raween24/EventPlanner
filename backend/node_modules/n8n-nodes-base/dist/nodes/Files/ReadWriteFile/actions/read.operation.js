...
async function execute(items) {
    ...
    for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
        try {
            fileSelector = (0, utils_1.normalizeFileSelector)(this.getNodeParameter('fileSelector', itemIndex));
            ...
            if (files.length === 0 && nodeVersion > 1) {
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'No file(s) found', {
                    itemIndex,
            ...
            const nodeOperationError = utils_1.errorMapper.call(this, error, itemIndex, {
