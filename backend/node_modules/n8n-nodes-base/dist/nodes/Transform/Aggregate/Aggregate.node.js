...
class Aggregate {
    description = {
        ...
        builderHint: {
            message: 'Need to combine items from multiple branches? Use merge node. This nodes combines all items from one branch into one item.',
            relatedNodes: [
                {
    ...
    async execute() {
        ...
        if (aggregate === 'aggregateIndividualFields') {
            ...
            const fieldsToExclude = (0, utils_2.prepareFieldsArray)(this.getNodeParameter('fieldsToExclude', 0, ''), 'Fields To Exclude');
            const fieldsToInclude = (0, utils_2.prepareFieldsArray)(this.getNodeParameter('fieldsToInclude', 0, ''), 'Fields To Include');
