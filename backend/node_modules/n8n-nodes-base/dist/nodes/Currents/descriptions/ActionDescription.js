...
exports.actionFields = exports.actionOperations = void 0;
const common_descriptions_1 = require("./common.descriptions");
exports.actionOperations = [
    {
    ...
    },
    {
        ...
        routing: {
            send: {
                type: 'body',
                property: 'action',
                value: '={{ [{ "op": "tag", "details": { "tags": $value.split(",").map(t => t.trim()).filter(t => t) } }] }}',
            },
        },
    ...
    },
    {
        ...
        routing: {
            send: {
                type: 'body',
                property: 'matcher',
                value: '={{ { "op": "AND", "cond": [{ "type": { "signature": "testId", "titleContains": "title", "titleEquals": "title", "specContains": "file", "specEquals": "file" }[$parameter.matcherType] || "title", "op": { "signature": "eq", "titleContains": "inc", "titleEquals": "eq", "specContains": "inc", "specEquals": "eq" }[$parameter.matcherType] || "inc", "value": $value }] } }}',
            },
        },
...
//# sourceMappingURL=ActionDescription.js.map