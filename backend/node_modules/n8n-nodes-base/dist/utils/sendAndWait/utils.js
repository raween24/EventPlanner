...
function getSendAndWaitProperties(targetProperties, resource = 'message', additionalProperties = [], options) {
    ...
    const sendAndWait = [
        ...
        },
        {
            ...
            placeholder: 'Add option',
            default: {},
            options: [descriptions_1.limitWaitTimeOption, appendAttributionOption, ...(options?.extraOptions ?? [])],
            displayOptions: {
                show: {
                    responseType: ['approval'],
                },
...
async function sendAndWaitWebhook() {
    ...
    if (responseType === 'approval' &&
        ((0, isbot_1.default)(req.headers['user-agent']) ||
    ...
    if (responseType === 'customForm') {
        ...
        let fields = [];
        if (defineForm === 'json') {
            fields = (0, utils_1.parseFormFields)(this, {
                defineForm: 'json',
        ...
        if (method === 'GET') {
            const { formTitle, formDescription, buttonLabel, customCss } = getFormResponseCustomizations(this);
            fields = (0, utils_1.prepareFormFields)(fields);
            const data = (0, utils_1.prepareFormData)({
                formTitle,
                formDescription,
                formSubmittedHeader: 'Got it, thanks',
