...
exports.prepareBinariesDataList = prepareBinariesDataList;
...
async function extractDataFromPDF(binaryPropertyName, password, maxPages, joinPages = true, itemIndex = 0) {
    ...
    if (typeof globalThis.DOMMatrix === 'undefined') {
        const { default: DOMMatrix } = await Promise.resolve().then(() => __importStar(require('@thednp/dommatrix')));
...
function prepareBinariesDataList(data) {
