...
let CommunityNode = class CommunityNode extends base_command_1.BaseCommand {
    ...
    async pruneDependencies() {
        ...
        await (0, npm_utils_1.executeNpmCommand)(['prune'], { cwd: instanceSettings.nodesDownloadDir });
    }
    async deleteCommunityNode(node) {
        return await di_1.Container.get(installed_nodes_repository_1.InstalledNodesRepository).delete({
            type: node.type,
        });
    }
...
//# sourceMappingURL=community-node.command.js.map