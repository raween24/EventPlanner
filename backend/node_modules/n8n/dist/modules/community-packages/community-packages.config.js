...
let CommunityPackagesConfig = class CommunityPackagesConfig {
    constructor() {
        ...
        this.aiNodeSdkVersion = ai_utilities_1.AI_NODE_SDK_VERSION;
    }
};
...
__decorate([
    (0, config_1.Env)('N8N_COMMUNITY_PACKAGES_REGISTRY'),
    __metadata("design:type", String)
], CommunityPackagesConfig.prototype, "registry", void 0);
__decorate([
    (0, config_1.Env)('N8N_REINSTALL_MISSING_PACKAGES'),
    __metadata("design:type", Boolean)
], CommunityPackagesConfig.prototype, "reinstallMissing", void 0);
__decorate([
    (0, config_1.Env)('N8N_UNVERIFIED_PACKAGES_ENABLED'),
    __metadata("design:type", Boolean)
], CommunityPackagesConfig.prototype, "unverifiedEnabled", void 0);
__decorate([
    (0, config_1.Env)('N8N_VERIFIED_PACKAGES_ENABLED'),
    __metadata("design:type", Boolean)
], CommunityPackagesConfig.prototype, "verifiedEnabled", void 0);
__decorate([
    (0, config_1.Env)('N8N_COMMUNITY_PACKAGES_PREVENT_LOADING'),
    __metadata("design:type", Boolean)
