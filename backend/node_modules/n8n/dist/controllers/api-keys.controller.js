...
let ApiKeysController = class ApiKeysController {
    constructor(eventService, publicApiKeyService, license) {
    ...
    resolveScopesForUser(user, requestedScopes) {
        return this.license.isLicensed(constants_1.LICENSE_FEATURES.API_KEY_SCOPES)
            ? requestedScopes
            : (0, permissions_1.getApiKeyScopesForRole)(user);
    }
};
exports.ApiKeysController = ApiKeysController;
__decorate([
    (0, decorators_1.GlobalScope)('apiKey:manage'),
    (0, decorators_1.Post)('/', { middlewares: [exports.isApiEnabledMiddleware] }),
    __param(2, decorators_1.Body),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Response,
        api_types_1.CreateApiKeyRequestDto]),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Response]),
    __metadata("design:returntype", Promise)
], ApiKeysController.prototype, "getApiKeyScopes", null);
