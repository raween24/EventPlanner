...
let PasswordResetController = class PasswordResetController {
    constructor(logger, externalHooks, mailer, authService, userService, mfaService, license, passwordUtility, userRepository, eventService, errorReporter) {
        this.logger = logger;
    ...
    async forgotPassword(_req, _res, payload) {
        ...
        try {
            ...
            this.errorReporter.error(new Error('Unexpected error in forgot password endpoint', { cause: error }));
        }
    }
...
__decorate([
    (0, decorators_1.Post)('/forgot-password', {
        ...
        keyedRateLimit: (0, decorators_1.createBodyKeyedRateLimiter)({
            limit: 3,
            field: 'email',
        }),
        middlewares: [(0, middlewares_1.createJitterMiddleware)({ minMs: 200, maxMs: 1000 })],
    }),
...
__decorate([
    (0, decorators_1.Get)('/resolve-password-token', { skipAuth: true, ipRateLimit: true }),
