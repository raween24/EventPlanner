...
let UsersController = UsersController_1 = class UsersController {
    constructor(logger, externalHooks, sharedCredentialsRepository, sharedWorkflowRepository, userRepository, authService, userService, projectRepository, workflowService, credentialsService, eventService, folderService, jwtService, urlService) {
        this.logger = logger;
    ...
    async generateInviteLink(req, _res) {
        const inviterId = req.user.id;
        const inviteeId = req.params.id;
        const targetUser = await this.userRepository.findOne({ where: { id: inviteeId } });
        if (!targetUser) {
            throw new not_found_error_1.NotFoundError('User to generate invite link for not found');
        }
...
__decorate([
    (0, decorators_1.Post)('/:id/invite-link'),
    (0, decorators_1.GlobalScope)('user:generateInviteLink'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "generateInviteLink", null);
__decorate([
