...
let AiController = class AiController {
    constructor(aiService, workflowBuilderService, credentialsService, userService, aiUsageService) {
    ...
    async truncateMessages(req, _, payload) {
        try {
            const success = await this.workflowBuilderService.truncateMessagesAfter(payload.workflowId, req.user, payload.messageId, payload.codeBuilder);
            return { success };
        }
        catch (e) {
            (0, node_assert_1.strict)(e instanceof Error);
