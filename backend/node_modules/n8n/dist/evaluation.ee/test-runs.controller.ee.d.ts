...
export declare class TestRunsController {
    ...
    constructor(testRunRepository: TestRunRepository, workflowFinderService: WorkflowFinderService, testCaseExecutionRepository: TestCaseExecutionRepository, testRunnerService: TestRunnerService, telemetry: Telemetry);
    private getTestRun;
