...
let TestRunsController = class TestRunsController {
    constructor(testRunRepository, workflowFinderService, testCaseExecutionRepository, testRunnerService, telemetry) {
    ...
    async getTestRun(testRunId, workflowId, user) {
        const sharedWorkflowsIds = await (0, workflows_service_1.getSharedWorkflowIds)(user, ['workflow:read']);
