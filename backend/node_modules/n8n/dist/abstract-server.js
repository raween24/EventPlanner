...
let AbstractServer = class AbstractServer {
    constructor() {
        ...
        this.app.engine('handlebars', (0, handlebars_util_1.createHandlebarsEngine)());
        ...
        this.endpointHealth = (0, health_endpoint_util_1.resolveHealthEndpointPath)(this.globalConfig);
