...
export declare const TRIGGER_COUNT_EXCLUDED_NODES: string[];
...
export declare const NPM_COMMAND_TOKENS: {
    readonly NPM_PACKAGE_NOT_FOUND_ERROR: "404 Not Found";
    readonly NPM_PACKAGE_VERSION_NOT_FOUND_ERROR: "No matching version found for";
    readonly NPM_NO_VERSION_AVAILABLE: "No valid versions available";
    readonly NPM_DISK_NO_SPACE: "ENOSPC";
    readonly NPM_DISK_INSUFFICIENT_SPACE: "insufficient space";
};
