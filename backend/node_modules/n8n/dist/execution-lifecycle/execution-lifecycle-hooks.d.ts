...
import type { IWorkflowBase, RelatedExecution, WorkflowExecuteMode, IWorkflowExecutionDataProcess } from 'n8n-workflow';
export declare function getLifecycleHooksForSubExecutions(mode: WorkflowExecuteMode, executionId: string, workflowData: IWorkflowBase, userId?: string, parentExecution?: RelatedExecution): ExecutionLifecycleHooks;
