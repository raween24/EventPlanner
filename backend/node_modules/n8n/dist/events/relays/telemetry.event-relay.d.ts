...
export declare class TelemetryEventRelay extends EventRelay {
    ...
    constructor(eventService: EventService, telemetry: Telemetry, license: License, licenseState: LicenseState, globalConfig: GlobalConfig, instanceSettings: InstanceSettings, binaryDataConfig: BinaryDataConfig, workflowRepository: WorkflowRepository, nodeTypes: NodeTypes, sharedWorkflowRepository: SharedWorkflowRepository, projectRelationRepository: ProjectRelationRepository, credentialsRepository: CredentialsRepository);
    init(): Promise<void>;
...
export declare function getSemanticVersioning(versionCli: string): {
    major: number | null;
    minor: number | null;
    patch: number | null;
};
