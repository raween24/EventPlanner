...
import type { CancellationReason, IPersonalizationSurveyAnswersV4, IRun, IWorkflowBase, IWorkflowExecutionDataProcess, JsonValue, WorkflowExecuteMode, WorkflowSettings } from 'n8n-workflow';
...
export type RelayEventMap = {
    ...
    'workflow-executed': {
        ...
        workflowName: string;
        executionId: string;
        source: 'user-manual' | 'user-retry' | 'webhook' | 'trigger' | 'error' | 'cli' | 'integrated' | 'evaluation' | 'chat';
    };
    ...
    'user-transactional-email-sent': {
        userId: string;
        messageType: 'Reset password' | 'New user invite' | 'Resend invite' | 'Workflow auto-deactivated' | 'Workflow shared' | 'Credentials shared' | 'Project shared';
        publicApi: boolean;
    };
    ...
    'email-failed': {
        user: UserLike;
        messageType: 'Reset password' | 'New user invite' | 'Resend invite' | 'Workflow shared' | 'Workflow auto-deactivated' | 'Credentials shared' | 'Project shared';
        publicApi: boolean;
    };
    'credentials-created': {
        user: UserLike;
