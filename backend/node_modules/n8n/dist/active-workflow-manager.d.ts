...
import { ActiveWorkflows, ErrorReporter, InstanceSettings, StorageConfig, type IGetExecutePollFunctions, type IGetExecuteTriggerFunctions } from 'n8n-core';
...
export declare class ActiveWorkflowManager {
    ...
    handleAddWebhooksTriggersAndPollers({ workflowId, activeVersionId, activationMode, }: PubSubCommandMap['add-webhooks-triggers-and-pollers']): Promise<void>;
