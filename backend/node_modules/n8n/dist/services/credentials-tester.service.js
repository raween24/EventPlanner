    ...
    async testCredentials(userId, credentialType, credentialsDecrypted) {
        ...
        if (credentialsDecrypted.data) {
            try {
                ...
                credentialsDecrypted.data = await this.credentialsHelper.applyDefaultsAndOverwrites(additionalData, credentialsDecrypted.data, credentialType, 'internal', undefined, undefined);
            }
            catch (error) {
