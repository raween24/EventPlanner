...
import { SettingsRepository, WorkflowRepository, WorkflowStatisticsRepository } from '@n8n/db';
...
export declare class WorkflowStatisticsService extends TypedEmitter<WorkflowStatisticsEvents> {
    ...
    constructor(logger: Logger, repository: WorkflowStatisticsRepository, ownershipService: OwnershipService, userService: UserService, eventService: EventService, settingsRepository: SettingsRepository, workflowRepository: WorkflowRepository);
