...
let FolderService = class FolderService {
        ...
        if (parentFolderId) {
            ...
            if (parentFolderId !== n8n_workflow_1.PROJECT_ROOT) {
                ...
                if (this.isDescendant(folderId, parentFolderPath)) {
                    throw new n8n_workflow_1.UserError("Cannot set a folder's parent to a folder that is a descendant of the current folder");
                }
            }
    ...
    async flattenAndArchive(user, folderId, projectId) {
        const workflowIds = await this.workflowRepository.getAllWorkflowIdsInHierarchy(folderId, projectId);
...
exports.FolderService = FolderService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [db_1.FolderRepository,
