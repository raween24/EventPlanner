...
let ProjectService = class ProjectService {
    constructor(sharedWorkflowRepository, projectRepository, projectRelationRepository, roleService, sharedCredentialsRepository, licenseState, moduleRegistry) {
    ...
    async createTeamProjectWithEntityManager(adminUser, data, trx) {
        ...
        const project = await trx.save(db_1.Project, this.projectRepository.create({ ...data, type: 'team', creatorId: adminUser.id }));
