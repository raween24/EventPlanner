...
let Start = class Start extends base_command_1.BaseCommand {
    ...
    async init() {
        ...
        const { AuthHandlerRegistry } = await Promise.resolve().then(() => __importStar(require('../auth/auth-handler.registry')));
