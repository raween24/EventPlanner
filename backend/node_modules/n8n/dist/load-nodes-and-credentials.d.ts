...
import type { LoadedClass, ICredentialType, INodeType, IVersionedNodeType, LoadedNodesAndCredentials } from 'n8n-workflow';
export declare class LoadNodesAndCredentials {
    ...
    private augmentNodeTypeDescription;
