...
Today is {{ $today }}
`}},type:`@n8n/n8n-nodes-langchain.agent`,typeVersion:3,position:[192,64],id:`ce5dd204-b9d3-4455-ab0c-0c2ce314ad52`,name:`AI Agent`}],pinData:{},connections:{"When chat message received":{main:[[{node:`AI Agent`,type:`main`,index:0}]]},"OpenAI Model":{ai_languageModel:[[{node:`AI Agent`,type:`ai_languageModel`,index:0}]]},"Simple Memory":{ai_memory:[[{node:`AI Agent`,type:`ai_memory`,index:0}]]},Hackernews:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},TheVerge:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"BBC News":{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"Google Sheets":{ai_tool:[[]]}}},D=b(p.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2,()=>{let e=c(),t=d(),r=n(()=>e.getVariant(v.name)),i=n(()=>r.value===v.variant5),a=n(()=>r.value===v.variant6),o=n(()=>t.userIsTrialing&&(i.value||a.value));return{currentVariant:r,getWorkflowForVariant:()=>{if(o.value){if(i.value)return T;if(a.value)return E}},isFeatureEnabled:o}});var O=`N8N_READY_TO_RUN_OPENAI_CREDENTIAL_ID`;const k=b(p.READY_TO_RUN,()=>{let t=[`ready-to-run-ai-workflow`,`ready-to-run-ai-workflow-v5`,`ready-to-run-ai-workflow-v6`],o=u(),c=i(),d=s(),p=a(),v=l(),b=h(),x=f(),C=m(),T=D(),E=r(O,``),k=e(!1),A=n(()=>!!v.allCredentials.filter(e=>e.type===g).length),j=n(()=>!!b.currentUser?.settings?.userClaimedAiCredits),M=n(()=>x.isAiCreditsEnabled&&!A.value&&!j.value),N=e=>{o.track(`User executed ready to run AI workflow`,{status:e})},P=()=>{o.track(`User executed ready to run AI workflow successfully`)},F=async e=>{k.value=!0;try{let t=await v.claimFreeAiCredits(e);return E.value=t.id,o.track(`User claimed OpenAI credits`),t}catch(e){throw d.showError(e,c.baseText(`freeAi.credits.showError.claim.title`),c.baseText(`freeAi.credits.showError.claim.message`)),e}finally{k.value=!1}},I=()=>T.getWorkflowForVariant()??S,L=async(e,t)=>{o.track(`User opened ready to run AI workflow`,{source:e});try{let e={...I(),parentFolderId:t},n=E.value;if(n&&e.nodes){let t=_(e),r=t.nodes?.find(e=>e.name===`OpenAI Model`);r&&(r.credentials??={},r.credentials[g]={id:n,name:``}),e=t}let r=await C.createNewWorkflow(e);return await p.push({name:y.WORKFLOW,params:{name:r.id}}),r}catch(e){throw d.showError(e,c.baseText(`generic.error`)),e}},R=async(e,t,n)=>{await F(n),await L(e,t),b?.currentUser?.settings&&(b.currentUser.settings.userClaimedAiCredits=!0)},z=(e,t)=>M.value&&!t&&e,B=(e,t,n)=>M.value&&!n&&t&&e,{isTrulyEmpty:V}=w();return{claimingCredits:k,userCanClaimOpenAiCredits:M,claimFreeAiCredits:F,createAndOpenAiWorkflow:L,claimCreditsAndOpenWorkflow:R,getCardVisibility:z,getButtonVisibility:B,getSimplifiedLayoutVisibility:e=>V(e),trackExecuteAiWorkflow:N,trackExecuteAiWorkflowSuccess:P,isReadyToRunTemplateId:e=>!!e&&t.includes(e)}});export{S as i,T as n,C as r,k as t};
//# sourceMappingURL=readyToRun.store-B_8_cTY4.js.map