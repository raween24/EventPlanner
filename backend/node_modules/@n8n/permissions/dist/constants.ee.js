...
exports.PERSONAL_SPACE_SHARING_SETTING = exports.PERSONAL_SPACE_PUBLISHING_SETTING = exports.PROJECT_CHAT_USER_ROLE_SLUG = exports.PROJECT_VIEWER_ROLE_SLUG = exports.PROJECT_EDITOR_ROLE_SLUG = exports.PROJECT_ADMIN_ROLE_SLUG = exports.PROJECT_OWNER_ROLE_SLUG = exports.API_KEY_RESOURCES = exports.RESOURCES = exports.DEFAULT_OPERATIONS = void 0;
...
exports.RESOURCES = {
    ...
    credential: ['share', 'unshare', 'shareGlobally', 'move', ...exports.DEFAULT_OPERATIONS],
...
exports.API_KEY_RESOURCES = {
    ...
    execution: ['delete', 'read', 'retry', 'list', 'get', 'stop'],
    credential: ['create', 'update', 'move', 'delete', 'list'],
    sourceControl: ['pull'],
    workflowTags: ['update', 'list'],
    executionTags: ['update', 'list'],
    dataTable: ['create', 'read', 'update', 'delete', 'list'],
...
exports.PERSONAL_SPACE_PUBLISHING_SETTING = {
    key: 'security.personalSpacePublishing',
    scopes: ['workflow:publish'],
};
exports.PERSONAL_SPACE_SHARING_SETTING = {
