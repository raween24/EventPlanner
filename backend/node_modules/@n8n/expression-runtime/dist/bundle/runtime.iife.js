...
`)}catch{return n}return e}function Gh(n){return n.replace(/<[^>]*>?/gm,"")}function vh(n){let e=new Date(Date.parse(n));if(e.toString()==="Invalid Date")throw new k("cannot convert to date");return/:/.test(n)||e.setHours(0,0,0),e}function na(n,e=[""]){try{let[a]=e;return a?a==="ms"||a==="s"||a==="us"||a==="excel"?ea(Number(n),[a]):Y.fromFormat(n,a):Mj(n)}catch{throw new k("cannot convert to Luxon DateTime")}}function Eh(n,e){let[a=!1]=e;return a?decodeURI(n.toString()):decodeURIComponent(n.toString())}function Ph(n,e){let[a=!1]=e;return a?encodeURI(n.toString()):encodeURIComponent(n.toString())}function Hi(n,e){let[a]=e,i=parseInt(n.replace(Ji,""),a);if(isNaN(i))throw new k("cannot convert to integer");return i}function Mi(n){if(n.includes(","))throw new k("cannot convert to float, expected . as decimal separator");let e=parseFloat(n.replace(Ji,""));if(isNaN(e))throw new k("cannot convert to float");return e}function Ah(n){let e=Number(n.replace(Ji,""));if(isNaN(e))throw new k("cannot convert to number");return e}function Rh(n,e){let[a='"']=e;return`${a}${n.replace(/\\/g,"\\\\").replace(new RegExp(`\\${a}`,"g"),`\\${a}`)}${a}`}function Wh(n){return n.includes(" ")?!1:!isNaN(n)&&!isNaN(parseFloat(n))}function Oh(n){return xj.test(n)}function Kh(n){return Jj.test(n)}function Ni(n){let e=xi.test(n);return e&&n.includes(" ")?!1:e}function Ih(n){return fh(n)}function Uh(n){return $n(n,{unknown:"?"})}function zh(n){let e=n.slice(),a="";for(;Xh.test(e);){let i=e.search(Xh);e=e.slice(0,i)+e[i].toLocaleUpperCase()+e.slice(i+1).toLocaleLowerCase();let o=e.search(Hj);if(o===-1){a+=e,e="";break}a+=e.slice(0,o+1),e=e.slice(o+1)}return a}function _h(n){return n.toLocaleLowerCase().replace(/[ \-]/g,"_").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,.\/:;<=>?@\[\]^`{|}~]/g,"")}function qh(n){let e=xi.exec(n);if(e)return e[0]}function Vh(n){if(Ni(n)){let a=xi.exec(n);return a?a.groups?.domain:void 0}let e=n.match(Dj);if(e)return e[1]}function $h(n){let e=Xj.exec(n);if(e)return e[0]}function el(n){try{return new URL(n).pathname}catch{return}}function nl(n){try{return JSON.parse(n)}catch{throw n.includes("'")?new k("Parsing failed. Check you're using double quotes"):new k("Parsing failed")}}function al(n){let e=n.toLowerCase(),a=new Set(["false","no","0"]);return e.length>0&&!a.has(e)}function il(n){return fi(n)}function ol(n){return Wg(n)}Qh.doc={name:"removeMarkdown",description:"Removes any Markdown formatting from the string. Also removes HTML tags.",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-removeMarkdown",examples:[{example:'"*bold*, [link]()".removeMarkdown()',evaluated:'"bold, link"'}]};Gh.doc={name:"removeTags",description:"Removes tags, such as HTML or XML, from the string.",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-removeTags",examples:[{example:'"<b>bold</b>, <a>link</a>".removeTags()',evaluated:'"bold, link"'}]};vh.doc={name:"toDate",description:"Converts a string to a date.",section:"cast",returnType:"Date",hidden:!0,docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toDate"};na.doc={name:"toDateTime",description:'Converts the string to a <a target="_blank" href="https://moment.github.io/luxon/api-docs/">Luxon</a> DateTime. Useful for further transformation. Supported formats for the string are ISO 8601, HTTP, RFC2822, SQL and Unix timestamp in milliseconds. To parse other formats, use <a target="_blank" href="https://moment.github.io/luxon/api-docs/index.html#datetimefromformat"> <code>DateTime.fromFormat()</code></a>.',section:"cast",returnType:"DateTime",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toDateTime",examples:[{example:'"2024-03-29T18:06:31.798+01:00".toDateTime()'},{example:'"Fri, 29 Mar 2024 18:08:01 +0100".toDateTime()'},{example:'"20240329".toDateTime()'},{example:'"1711732132990".toDateTime("ms")'},{example:'"31-01-2024".toDateTime("dd-MM-yyyy")'}],args:[{name:"format",optional:!0,description:'The format of the date string. Options are <code>ms</code> (for Unix timestamp in milliseconds), <code>s</code> (for Unix timestamp in seconds), <code>us</code> (for Unix timestamp in microseconds) or <code>excel</code> (for days since 1900). Custom formats can be specified using <a href="https://moment.github.io/luxon/#/formatting?id=table-of-tokens">Luxon tokens</a>.',type:"string"}]};al.doc={name:"toBoolean",description:"Converts the string to a boolean value. <code>0</code>, <code>false</code> and <code>no</code> resolve to <code>false</code>, everything else to <code>true</code>. Case-insensitive.",section:"cast",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toBoolean",examples:[{example:'"true".toBoolean()',evaluated:"true"},{example:'"false".toBoolean()',evaluated:"false"},{example:'"0".toBoolean()',evaluated:"false"},{example:'"hello".toBoolean()',evaluated:"true"}]};Mi.doc={name:"toFloat",description:"Converts a string to a decimal number.",section:"cast",returnType:"number",aliases:["toDecimalNumber"],hidden:!0,docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toDecimalNumber"};Hi.doc={name:"toInt",description:"Converts a string to an integer.",section:"cast",returnType:"number",args:[{name:"radix?",type:"number"}],aliases:["toWholeNumber"],hidden:!0,docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toInt"};zh.doc={name:"toSentenceCase",description:"Changes the capitalization of the string to sentence case. The first letter of each sentence is capitalized and all others are lowercased.",examples:[{example:'"quick! brown FOX".toSentenceCase()',evaluated:'"Quick! Brown fox"'}],section:"case",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toSentenceCase"};_h.doc={name:"toSnakeCase",description:"Changes the format of the string to snake case. Spaces and dashes are replaced by <code>_</code>, symbols are removed and all letters are lowercased.",examples:[{example:'"quick brown $FOX".toSnakeCase()',evaluated:'"quick_brown_fox"'}],section:"case",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toSnakeCase"};Ih.doc={name:"toTitleCase",description:"Changes the capitalization of the string to title case. The first letter of each word is capitalized and the others left unchanged. Short prepositions and conjunctions aren't capitalized (e.g. 'a', 'the').",examples:[{example:'"quick a brown FOX".toTitleCase()',evaluated:'"Quick a Brown Fox"'}],section:"case",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toTitleCase"};Ph.doc={name:"urlEncode",description:"Encodes the string so that it can be used in a URL. Spaces and special characters are replaced with codes of the form <code>%XX</code>.",section:"edit",args:[{name:"allChars",optional:!0,description:"Whether to encode characters that are part of the URI syntax (e.g. <code>=</code>, <code>?</code>)",default:"false",type:"boolean"}],returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-urlEncode",examples:[{example:'"name=Nathan Automat".urlEncode()',evaluated:'"name%3DNathan%20Automat"'},{example:'"name=Nathan Automat".urlEncode(true)',evaluated:'"name=Nathan%20Automat"'}]};Eh.doc={name:"urlDecode",description:"Decodes a URL-encoded string. Replaces any character codes in the form of <code>%XX</code> with their corresponding characters.",args:[{name:"allChars",optional:!0,description:"Whether to decode characters that are part of the URI syntax (e.g. <code>=</code>, <code>?</code>)",default:"false",type:"boolean"}],section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-urlDecode",examples:[{example:'"name%3DNathan%20Automat".urlDecode()',evaluated:'"name=Nathan Automat"'},{example:'"name%3DNathan%20Automat".urlDecode(true)',evaluated:'"name%3DNathan Automat"'}]};Uh.doc={name:"replaceSpecialChars",description:"Replaces special characters in the string with the closest ASCII character",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-replaceSpecialChars",examples:[{example:'"d\xE9j\xE0".replaceSpecialChars()',evaluated:'"deja"'}]};Fh.doc={name:"length",section:"query",hidden:!0,description:"Returns the character count of a string.",returnType:"number",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings"};Kh.doc={name:"isDomain",description:"Returns <code>true</code> if a string is a domain.",section:"validation",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-isDomain",examples:[{example:'"n8n.io".isDomain()',evaluated:"true"},{example:'"http://n8n.io".isDomain()',evaluated:"false"},{example:'"hello".isDomain()',evaluated:"false"}]};Ni.doc={name:"isEmail",description:"Returns <code>true</code> if the string is an email.",section:"validation",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-isEmail",examples:[{example:'"me@example.com".isEmail()',evaluated:"true"},{example:`"It's me@example.com".isEmail()`,evaluated:"false"},{example:'"hello".isEmail()',evaluated:"false"}]};Wh.doc={name:"isNumeric",description:"Returns <code>true</code> if the string represents a number.",section:"validation",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-isNumeric",examples:[{example:'"1.2234".isNumeric()',evaluated:"true"},{example:'"hello".isNumeric()',evaluated:"false"},{example:'"123E23".isNumeric()',evaluated:"true"}]};Oh.doc={name:"isUrl",description:"Returns <code>true</code> if a string is a valid URL",section:"validation",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-isUrl",examples:[{example:'"https://n8n.io".isUrl()',evaluated:"true"},{example:'"n8n.io".isUrl()',evaluated:"false"},{example:'"hello".isUrl()',evaluated:"false"}]};Xi.doc={name:"isEmpty",description:"Returns <code>true</code> if the string has no characters or is <code>null</code>",section:"validation",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-isEmpty",examples:[{example:'"".isEmpty()',evaluated:"true"},{example:'"hello".isEmpty()',evaluated:"false"}]};Nh.doc={name:"isNotEmpty",description:"Returns <code>true</code> if the string has at least one character.",section:"validation",returnType:"boolean",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-isNotEmpty",examples:[{example:'"hello".isNotEmpty()',evaluated:"true"},{example:'"".isNotEmpty()',evaluated:"false"}]};Bh.doc={name:"toJsonString",description:"Prepares the string to be inserted into a JSON object. Escapes any quotes and special characters (e.g. new lines), and wraps the string in quotes.The same as JavaScript's JSON.stringify().",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toJsonString",examples:[{example:`The "best" colours: red
brown.toJsonString()`,evaluated:'"The \\"best\\" colours: red\\nbrown"'},{example:"foo.toJsonString()",evaluated:'"foo"'}]};qh.doc={name:"extractEmail",description:"Extracts the first email found in the string. Returns <code>undefined</code> if none is found.",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-extractEmail",examples:[{example:'"My email is me@example.com".extractEmail()',evaluated:"'me@example.com'"}]};Vh.doc={name:"extractDomain",description:"If the string is an email address or URL, returns its domain (or <code>undefined</code> if nothing found). If the string also contains other content, try using <code>extractEmail()</code> or <code>extractUrl()</code> first.",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-extractDomain",examples:[{example:'"me@example.com".extractDomain()',evaluated:"'example.com'"},{example:'"http://n8n.io/workflows".extractDomain()',evaluated:"'n8n.io'"},{example:`"It's me@example.com".extractEmail().extractDomain()`,evaluated:"'example.com'"}]};$h.doc={name:"extractUrl",description:"Extracts the first URL found in the string. Returns <code>undefined</code> if none is found. Only recognizes full URLs, e.g. those starting with <code>http</code>.",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-extractUrl",examples:[{example:'"Check out http://n8n.io".extractUrl()',evaluated:"'http://n8n.io'"}]};el.doc={name:"extractUrlPath",description:"Returns the part of a URL after the domain, or <code>undefined</code> if no URL found. If the string also contains other content, try using <code>extractUrl()</code> first.",section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-extractUrlPath",examples:[{example:'"http://n8n.io/workflows".extractUrlPath()',evaluated:"'/workflows'"},{example:'"Check out http://n8n.io/workflows".extractUrl().extractUrlPath()',evaluated:"'/workflows'"}]};Mh.doc={name:"hash",description:"Returns the string hashed with the given algorithm. Defaults to md5 if not specified.",section:"edit",returnType:"string",args:[{name:"algo",optional:!0,description:`The hashing algorithm to use. One of <code>md5</code>, <code>base64</code>, <code>sha1</code>, <code>sha224</code>, <code>sha256</code>, <code>sha384</code>, <code>sha512</code>, <code>sha3</code>, <code>ripemd160</code>
        `,default:'"md5"',type:"string"}],docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-hash",examples:[{example:'"hello".hash()',evaluated:"'5d41402abc4b2a76b9719d911017c592'"}]};Rh.doc={name:"quote",description:"Wraps a string in quotation marks, and escapes any quotation marks already in the string. Useful when constructing JSON, SQL, etc.",section:"edit",returnType:"string",args:[{name:"mark",optional:!0,description:"The type of quotation mark to use",default:'"',type:"string"}],docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-quote",examples:[{example:`'Nathan says "hi"'.quote()`,evaluated:`'"Nathan says \\"hi\\""'`}]};nl.doc={name:"parseJson",aliases:["fromJson"],description:"Returns the JavaScript value or object represented by the string, or <code>undefined</code> if the string isn't valid JSON. Single-quoted JSON is not supported.",section:"cast",returnType:"any",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-parseJson",examples:[{example:`'{"name":"Nathan"}'.parseJson()`,evaluated:`'{"name":"Nathan"}'`},{example:`"{'name':'Nathan'}".parseJson()`,evaluated:"undefined"},{example:"'hello'.parseJson()",evaluated:"undefined"}]};il.doc={name:"base64Encode",aliases:["toBase64"],description:"Converts plain text to a base64-encoded string",examples:[{example:'"hello".base64Encode()',evaluated:'"aGVsbG8="'}],section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-base64Encode"};ol.doc={name:"base64Decode",aliases:["fromBase64"],description:"Converts a base64-encoded string to plain text",examples:[{example:'"aGVsbG8=".base64Decode()',evaluated:'"hello"'}],section:"edit",returnType:"string",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-base64Decode"};Ah.doc={name:"toNumber",description:"Converts a string representing a number to a number. Errors if the string doesn't start with a valid number.",section:"cast",returnType:"number",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/strings/#string-toNumber",examples:[{example:'"123".toNumber()',evaluated:"123"},{example:'"1.23E10".toNumber()',evaluated:"12300000000"}]};var Nj=Mi.bind({}),Fj=Hi.bind({}),Fi={typeName:"String",functions:{hash:Mh,removeMarkdown:Qh,removeTags:Gh,toDate:vh,toDateTime:na,toBoolean:al,toDecimalNumber:Nj,toNumber:Ah,toFloat:Mi,toInt:Hi,toWholeNumber:Fj,toSentenceCase:zh,toSnakeCase:_h,toTitleCase:Ih,urlDecode:Eh,urlEncode:Ph,quote:Rh,replaceSpecialChars:Uh,length:Fh,isDomain:Kh,isEmail:Ni,isNumeric:Wh,isUrl:Oh,isEmpty:Xi,isNotEmpty:Nh,toJsonString:Bh,extractEmail:qh,extractDomain:Vh,extractUrl:$h,extractUrlPath:el,parseJson:nl,base64Encode:il,base64Decode:ol}};var Bi=n=>{let e;if(typeof n=="string"){if(e=Y.fromJSDate(new Date(n)),e.invalidReason!==null)return}else n instanceof Date?e=Y.fromJSDate(n):Y.isDateTime(n)&&(e=n);return e};function ul(n,e){if(n==null)throw new k(`${e} can't be used on ${String(n)} value`,{description:`To ignore this error, add a ? to the variable before this function, e.g. my_var?.${e}`})}var tl=["milliseconds","seconds","minutes","hours","days","weeks","months","quarters","years"],Bj=["day","week","month","year","hour","minute","second","millisecond","weekNumber","yearDayNumber","weekday"],Qj={day:"days",month:"months",year:"years",week:"weeks",hour:"hours",minute:"minutes",second:"seconds",millisecond:"milliseconds",ms:"milliseconds",sec:"seconds",secs:"seconds",hr:"hours",hrs:"hours",min:"minutes",mins:"minutes"},sl={days:"day",months:"month",years:"year",hours:"hour",minutes:"minute",seconds:"second",milliseconds:"millisecond",hrs:"hour",hr:"hour",mins:"minute",min:"minute",secs:"second",sec:"second",ms:"millisecond"};function E(n){return n?Y.isDateTime(n):!1}function Qi(n){return E(n)?n:typeof n=="string"?na(n):Y.fromJSDate(n)}function Gi(n,e){return{[`${Qj[e]||e}`]:n}}function rl(n,e){let[a="week"]=e,i=sl[a]||a;return E(n)?n.startOf(i):Y.fromJSDate(n).startOf(i).toJSDate()}function gl(n){return E(n)?n.endOf("month"):Y.fromJSDate(n).endOf("month").toJSDate()}function hl(n,e){let[a="week"]=e;if(a==="yearDayNumber"){n=E(n)?n.toJSDate():n;let o=new Date(n.getFullYear(),0,0),u=n.getTime()-o.getTime()+(o.getTimezoneOffset()-n.getTimezoneOffset())*60*1e3;return Math.floor(u/(1e3*60*60*24))}a==="week"&&(a="weekNumber");let i=sl[a]||a;return E(n)?n.get(i):Y.fromJSDate(n).get(i)}function ll(n,e){let[a,i={}]=e;return E(n)?n.toFormat(a,{...i}):Y.fromJSDate(n).toFormat(a,{...i})}function dl(n,e){if(e.length!==2)throw new k("isBetween(): expected exactly two args");let[a,i]=e,o=Bi(a),u=Bi(i);if(!(!o||!u))return o>u?u<n&&n<o:u>n&&n>o}function yl(n){return E(n)?n.isInDST:Y.fromJSDate(n).isInDST}function cl(n,e){let[a=0,i="minutes"]=e,o=Y.now().minus(Gi(a,i)),u=n;return E(u)||(u=Y.fromJSDate(u)),o<=u&&u<=Y.now()}var Gj=[6,7];function ml(n){let{weekday:e}=E(n)?n:Y.fromJSDate(n);return Gj.includes(e)}function bl(n,e){if(e.length===1){let[u]=e;return E(n)?n.minus(u):Y.fromJSDate(n).minus(u).toJSDate()}let[a=0,i="minutes"]=e,o=Gi(a,i);return E(n)?n.minus(o):Y.fromJSDate(n).minus(o).toJSDate()}function wl(n,e){if(e.length===1){let[u]=e;return E(n)?n.plus(u):Y.fromJSDate(n).plus(u).toJSDate()}let[a=0,i="minutes"]=e,o=Gi(a,i);return E(n)?n.plus(o):Y.fromJSDate(n).plus(o).toJSDate()}function vi(n,e){let[a,i="days"]=e,o=Array.isArray(i)?i:[i];o.length===0&&(o=["days"]);let u=new Set([...Bj,...tl]),s=o.find(r=>!u.has(r));if(s)throw new k(`Unsupported unit '${String(s)}'. Supported: ${tl.map(r=>`'${r}'`).join(", ")}.`);let t=n.diff(Qi(a),o);return o.length>1?t.toObject():t.as(o[0])}function pl(n,e){let[a]=e;return vi(n,[Y.now(),a])}function fl(n){return E(n)?n.toMillis():n.getTime()}var vj=fl;function Ej(){}function jl(){return!1}function Yl(){return!0}gl.doc={name:"endOfMonth",returnType:"DateTime",hidden:!0,description:"Transforms a date to the last possible moment that lies within the month.",section:"edit",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-endOfMonth"};yl.doc={name:"isDst",returnType:"boolean",hidden:!0,description:"Checks if a Date is within Daylight Savings Time.",section:"query",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-isDst"};ml.doc={name:"isWeekend",returnType:"boolean",hidden:!0,description:"Checks if the Date falls on a Saturday or Sunday.",section:"query",docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-isWeekend"};rl.doc={name:"beginningOf",description:"Transform a Date to the start of the given time period. Default unit is `week`.",section:"edit",hidden:!0,returnType:"DateTime",args:[{name:"unit?",type:"DurationUnit"}],docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-beginningOf"};hl.doc={name:"extract",description:"Extracts a part of the date or time, e.g. the month, as a number. To extract textual names instead, see <code>format()</code>.",examples:[{example:`dt = '2024-03-30T18:49'.toDateTime()
dt.extract('month')`,evaluated:"3"},{example:`dt = '2024-03-30T18:49'.toDateTime()
dt.extract('hour')`,evaluated:"18"}],section:"query",returnType:"number",args:[{name:"unit",optional:!0,description:"The part of the date or time to return. One of: <code>year</code>, <code>month</code>, <code>week</code>, <code>day</code>, <code>hour</code>, <code>minute</code>, <code>second</code>",default:'"week"',type:"string"}],docURL:"https://docs.n8n.io/code/builtin/data-transformation-functions/dates/#date-extract"};ll.doc={name:"format",description:'Converts the DateTime to a string, using the format specified. <a target="_blank" href="https://moment.github.io/luxon/#/formatting?id=table-of-tokens">Formatting guide</a>. For common formats, <code>toLocaleString()</code> may be easier.',examples:[{example:`dt = '2024-04-30T18:49'.toDateTime()
