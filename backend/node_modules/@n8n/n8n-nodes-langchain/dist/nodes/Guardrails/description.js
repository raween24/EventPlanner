...
exports.propertiesDescription = void 0;
const jailbreak_1 = require("./actions/checks/jailbreak");
const nsfw_1 = require("./actions/checks/nsfw");
const pii_1 = require("./actions/checks/pii");
const topicalAlignment_1 = require("./actions/checks/topicalAlignment");
...
exports.propertiesDescription = [
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                options: [wrapValue([THRESHOLD_OPTION, ...getPromptOption(jailbreak_1.JAILBREAK_PROMPT)])],
                displayOptions: {
                    show: {
                        '/operation': ['classify'],
                    },
            ...
            },
            {
                ...
                options: [wrapValue([THRESHOLD_OPTION, ...getPromptOption(nsfw_1.NSFW_SYSTEM_PROMPT)])],
                displayOptions: {
                    show: {
                        '/operation': ['classify'],
                    },
                ...
                options: [
                    wrapValue([
                        ...
                        },
                        {
                            ...
                            options: Object.values(pii_1.PIIEntity).map((entity) => ({
                                name: pii_1.PII_NAME_MAP[entity],
                                value: entity,
                            })),
                        },
                    ]),
            ...
            },
            {
                ...
                options: [
                    wrapValue([
                        THRESHOLD_OPTION,
                        ...getPromptOption(topicalAlignment_1.TOPICAL_ALIGNMENT_SYSTEM_PROMPT, false, 'Make sure you replace the placeholder.'),
                    ]),
                ],
                displayOptions: {
                    show: {
    ...
    },
    {
        ...
        default: model_1.LLM_SYSTEM_RULES,
        typeOptions: {
            rows: 6,
        },
        displayOptions: {
