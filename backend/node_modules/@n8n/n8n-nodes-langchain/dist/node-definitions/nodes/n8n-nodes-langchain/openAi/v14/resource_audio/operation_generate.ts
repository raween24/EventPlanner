...
export type LcOpenAiV14AudioGenerateParams = {
  resource: 'audio';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV14AudioGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14AudioGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14AudioGenerateParams> & { subnodes?: LcOpenAiV14AudioGenerateSubnodeConfig };
};