...
export type LcVectorStoreSupabaseV11LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreSupabaseV11LoadSubnodeConfig {
...
export type LcVectorStoreSupabaseV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreSupabase';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreSupabaseV11LoadParams> & { subnodes: LcVectorStoreSupabaseV11LoadSubnodeConfig };
};