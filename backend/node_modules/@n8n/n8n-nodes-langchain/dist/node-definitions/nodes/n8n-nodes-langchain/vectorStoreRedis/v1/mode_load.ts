...
export type LcVectorStoreRedisV1LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreRedisV1LoadSubnodeConfig {
...
export type LcVectorStoreRedisV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreRedis';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreRedisV1LoadParams> & { subnodes: LcVectorStoreRedisV1LoadSubnodeConfig };
};