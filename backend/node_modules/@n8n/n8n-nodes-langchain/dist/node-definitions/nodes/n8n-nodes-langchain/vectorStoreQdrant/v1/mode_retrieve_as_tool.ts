...
export type LcVectorStoreQdrantV1RetrieveAsToolParams = {
...
export interface LcVectorStoreQdrantV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreQdrantV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV1RetrieveAsToolParams> & { subnodes: LcVectorStoreQdrantV1RetrieveAsToolSubnodeConfig };
};