...
export type LcVectorStoreWeaviateV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreWeaviateV12LoadSubnodeConfig {
...
export type LcVectorStoreWeaviateV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV12LoadParams> & { subnodes: LcVectorStoreWeaviateV12LoadSubnodeConfig };
};