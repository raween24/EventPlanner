...
export type LcVectorStorePGVectorV1RetrieveAsToolParams = {
...
export interface LcVectorStorePGVectorV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStorePGVectorV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV1RetrieveAsToolParams> & { subnodes: LcVectorStorePGVectorV1RetrieveAsToolSubnodeConfig };
};