...
export type LcVectorStorePGVectorV11RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStorePGVectorV11RetrieveSubnodeConfig {
...
export type LcVectorStorePGVectorV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV11RetrieveParams> & { subnodes: LcVectorStorePGVectorV11RetrieveSubnodeConfig };
};