...
export type LcVectorStorePGVectorV11LoadParams = {
  mode: 'load';
...
export interface LcVectorStorePGVectorV11LoadSubnodeConfig {
...
export type LcVectorStorePGVectorV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV11LoadParams> & { subnodes: LcVectorStorePGVectorV11LoadSubnodeConfig };
};