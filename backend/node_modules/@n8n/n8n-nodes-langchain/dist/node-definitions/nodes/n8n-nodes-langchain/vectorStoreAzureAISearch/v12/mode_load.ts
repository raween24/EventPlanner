...
export interface LcVectorStoreAzureAISearchV12LoadSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreAzureAISearchV12LoadParams> & { subnodes: LcVectorStoreAzureAISearchV12LoadSubnodeConfig };
};