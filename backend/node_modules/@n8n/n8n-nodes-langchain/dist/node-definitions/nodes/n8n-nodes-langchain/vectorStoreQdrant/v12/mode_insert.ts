...
export type LcVectorStoreQdrantV12InsertParams = {
  mode: 'insert';
...
export interface LcVectorStoreQdrantV12InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreQdrantV12InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV12InsertParams> & { subnodes: LcVectorStoreQdrantV12InsertSubnodeConfig };
};