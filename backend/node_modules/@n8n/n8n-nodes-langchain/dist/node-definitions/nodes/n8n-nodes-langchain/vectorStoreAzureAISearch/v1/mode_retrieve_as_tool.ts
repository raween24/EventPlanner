...
export interface LcVectorStoreAzureAISearchV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreAzureAISearchV1RetrieveAsToolParams> & { subnodes: LcVectorStoreAzureAISearchV1RetrieveAsToolSubnodeConfig };
};