...
export type LcOpenAiV17AudioTranslateParams = {
  resource: 'audio';
  operation: 'translate';
/**
...
export interface LcOpenAiV17AudioTranslateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17AudioTranslateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17AudioTranslateParams> & { subnodes?: LcOpenAiV17AudioTranslateSubnodeConfig };
};