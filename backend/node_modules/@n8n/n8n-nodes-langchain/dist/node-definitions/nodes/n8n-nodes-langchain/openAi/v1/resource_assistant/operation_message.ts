...
export type LcOpenAiV1AssistantMessageParams = {
  resource: 'assistant';
  operation: 'message';
/**
...
export interface LcOpenAiV1AssistantMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV1AssistantMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV1AssistantMessageParams> & { subnodes?: LcOpenAiV1AssistantMessageSubnodeConfig };
};