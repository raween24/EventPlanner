...
export type LcOpenAiV15AudioTranslateParams = {
  resource: 'audio';
  operation: 'translate';
/**
...
export interface LcOpenAiV15AudioTranslateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15AudioTranslateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15AudioTranslateParams> & { subnodes?: LcOpenAiV15AudioTranslateSubnodeConfig };
};