...
export type LcGoogleGeminiV11AudioAnalyzeParams = {
  resource: 'audio';
  operation: 'analyze';
/**
 * Model
...
export interface LcGoogleGeminiV11AudioAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV11AudioAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV11AudioAnalyzeParams> & { subnodes?: LcGoogleGeminiV11AudioAnalyzeSubnodeConfig };
};