...
export type LcOpenAiV12ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Text Input
...
export interface LcOpenAiV12ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV12ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV12ImageAnalyzeParams> & { subnodes?: LcOpenAiV12ImageAnalyzeSubnodeConfig };
};