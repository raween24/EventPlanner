...
export type LcVectorStoreWeaviateV1RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreWeaviateV1RetrieveSubnodeConfig {
...
export type LcVectorStoreWeaviateV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV1RetrieveParams> & { subnodes: LcVectorStoreWeaviateV1RetrieveSubnodeConfig };
};