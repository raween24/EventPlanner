...
export interface LcVectorStoreAzureAISearchV12RetrieveSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreAzureAISearchV12RetrieveParams> & { subnodes: LcVectorStoreAzureAISearchV12RetrieveSubnodeConfig };
};