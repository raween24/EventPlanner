...
export type LcVectorStorePineconeV11LoadParams = {
  mode: 'load';
...
export interface LcVectorStorePineconeV11LoadSubnodeConfig {
...
export type LcVectorStorePineconeV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV11LoadParams> & { subnodes: LcVectorStorePineconeV11LoadSubnodeConfig };
};