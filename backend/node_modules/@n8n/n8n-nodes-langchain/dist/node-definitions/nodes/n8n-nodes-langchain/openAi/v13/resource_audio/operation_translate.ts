...
export type LcOpenAiV13AudioTranslateParams = {
  resource: 'audio';
  operation: 'translate';
/**
...
export interface LcOpenAiV13AudioTranslateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV13AudioTranslateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.3;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV13AudioTranslateParams> & { subnodes?: LcOpenAiV13AudioTranslateSubnodeConfig };
};