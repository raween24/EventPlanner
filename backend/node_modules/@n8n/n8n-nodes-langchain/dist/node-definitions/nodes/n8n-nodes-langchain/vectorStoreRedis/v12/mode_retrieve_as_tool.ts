...
export type LcVectorStoreRedisV12RetrieveAsToolParams = {
...
export interface LcVectorStoreRedisV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreRedisV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreRedis';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreRedisV12RetrieveAsToolParams> & { subnodes: LcVectorStoreRedisV12RetrieveAsToolSubnodeConfig };
};