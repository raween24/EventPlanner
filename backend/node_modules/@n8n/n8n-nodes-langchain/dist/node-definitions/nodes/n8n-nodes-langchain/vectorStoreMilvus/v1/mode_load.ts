...
export interface LcVectorStoreMilvusV1LoadSubnodeConfig {
...
export type LcVectorStoreMilvusV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMilvus';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMilvusV1LoadParams> & { subnodes: LcVectorStoreMilvusV1LoadSubnodeConfig };
};