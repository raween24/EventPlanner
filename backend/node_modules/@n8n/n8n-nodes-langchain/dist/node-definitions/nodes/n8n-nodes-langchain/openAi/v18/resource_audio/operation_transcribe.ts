...
export type LcOpenAiV18AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV18AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV18AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.8;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV18AudioTranscribeParams> & { subnodes?: LcOpenAiV18AudioTranscribeSubnodeConfig };
};