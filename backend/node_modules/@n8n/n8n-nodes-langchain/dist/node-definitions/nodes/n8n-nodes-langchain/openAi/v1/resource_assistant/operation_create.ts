...
export type LcOpenAiV1AssistantCreateParams = {
  resource: 'assistant';
  operation: 'create';
/**
 * Model
...
export interface LcOpenAiV1AssistantCreateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV1AssistantCreateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV1AssistantCreateParams> & { subnodes?: LcOpenAiV1AssistantCreateSubnodeConfig };
};