...
export type LcVectorStoreSupabaseV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreSupabaseV12LoadSubnodeConfig {
...
export type LcVectorStoreSupabaseV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreSupabase';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreSupabaseV12LoadParams> & { subnodes: LcVectorStoreSupabaseV12LoadSubnodeConfig };
};