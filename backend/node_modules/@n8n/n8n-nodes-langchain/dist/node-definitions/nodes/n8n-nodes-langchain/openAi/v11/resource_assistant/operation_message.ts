...
export type LcOpenAiV11AssistantMessageParams = {
  resource: 'assistant';
  operation: 'message';
/**
...
export interface LcOpenAiV11AssistantMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV11AssistantMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV11AssistantMessageParams> & { subnodes?: LcOpenAiV11AssistantMessageSubnodeConfig };
};