...
export interface LcVectorStoreMongoDBAtlasV1RetrieveSubnodeConfig {
...
export type LcVectorStoreMongoDBAtlasV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV1RetrieveParams> & { subnodes: LcVectorStoreMongoDBAtlasV1RetrieveSubnodeConfig };
};