...
export interface LcVectorStoreChromaDBV11LoadSubnodeConfig {
...
export type LcVectorStoreChromaDBV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreChromaDB';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreChromaDBV11LoadParams> & { subnodes: LcVectorStoreChromaDBV11LoadSubnodeConfig };
};