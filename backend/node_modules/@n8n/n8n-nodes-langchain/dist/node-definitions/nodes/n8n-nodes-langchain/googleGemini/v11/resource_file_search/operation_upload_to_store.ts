...
export type LcGoogleGeminiV11FileSearchUploadToStoreParams = {
  resource: 'fileSearch';
...
export interface LcGoogleGeminiV11FileSearchUploadToStoreSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV11FileSearchUploadToStoreNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV11FileSearchUploadToStoreParams> & { subnodes?: LcGoogleGeminiV11FileSearchUploadToStoreSubnodeConfig };
};