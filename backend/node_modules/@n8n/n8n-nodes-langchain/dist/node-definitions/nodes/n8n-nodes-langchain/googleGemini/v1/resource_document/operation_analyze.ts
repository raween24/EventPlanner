...
export type LcGoogleGeminiV1DocumentAnalyzeParams = {
  resource: 'document';
  operation: 'analyze';
/**
 * Model
...
export interface LcGoogleGeminiV1DocumentAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV1DocumentAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV1DocumentAnalyzeParams> & { subnodes?: LcGoogleGeminiV1DocumentAnalyzeSubnodeConfig };
};