...
export type LcOpenAiV14TextMessageParams = {
  resource: 'text';
  operation: 'message';
/**
 * Model
...
export interface LcOpenAiV14TextMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14TextMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14TextMessageParams> & { subnodes?: LcOpenAiV14TextMessageSubnodeConfig };
};