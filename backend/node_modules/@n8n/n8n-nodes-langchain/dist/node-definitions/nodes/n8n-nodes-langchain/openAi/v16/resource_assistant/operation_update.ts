...
export type LcOpenAiV16AssistantUpdateParams = {
  resource: 'assistant';
  operation: 'update';
/**
...
export interface LcOpenAiV16AssistantUpdateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV16AssistantUpdateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.6;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV16AssistantUpdateParams> & { subnodes?: LcOpenAiV16AssistantUpdateSubnodeConfig };
};