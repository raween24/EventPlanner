...
export type LcOpenAiV12AssistantUpdateParams = {
  resource: 'assistant';
  operation: 'update';
/**
...
export interface LcOpenAiV12AssistantUpdateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV12AssistantUpdateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV12AssistantUpdateParams> & { subnodes?: LcOpenAiV12AssistantUpdateSubnodeConfig };
};