...
export type LcOpenAiV14ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Model
...
export interface LcOpenAiV14ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14ImageAnalyzeParams> & { subnodes?: LcOpenAiV14ImageAnalyzeSubnodeConfig };
};