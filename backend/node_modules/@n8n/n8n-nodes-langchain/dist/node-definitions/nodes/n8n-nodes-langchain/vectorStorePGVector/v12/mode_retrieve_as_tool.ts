...
export type LcVectorStorePGVectorV12RetrieveAsToolParams = {
...
export interface LcVectorStorePGVectorV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStorePGVectorV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV12RetrieveAsToolParams> & { subnodes: LcVectorStorePGVectorV12RetrieveAsToolSubnodeConfig };
};