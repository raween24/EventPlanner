...
export type LcVectorStoreZepV12RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreZepV12RetrieveSubnodeConfig {
...
export type LcVectorStoreZepV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV12RetrieveParams> & { subnodes: LcVectorStoreZepV12RetrieveSubnodeConfig };
};