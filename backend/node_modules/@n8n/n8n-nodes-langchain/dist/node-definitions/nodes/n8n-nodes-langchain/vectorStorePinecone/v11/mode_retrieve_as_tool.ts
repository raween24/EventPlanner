...
export type LcVectorStorePineconeV11RetrieveAsToolParams = {
...
export interface LcVectorStorePineconeV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStorePineconeV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV11RetrieveAsToolParams> & { subnodes: LcVectorStorePineconeV11RetrieveAsToolSubnodeConfig };
};