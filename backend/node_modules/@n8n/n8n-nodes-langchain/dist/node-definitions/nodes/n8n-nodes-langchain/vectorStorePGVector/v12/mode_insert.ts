...
export type LcVectorStorePGVectorV12InsertParams = {
  mode: 'insert';
...
export interface LcVectorStorePGVectorV12InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStorePGVectorV12InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV12InsertParams> & { subnodes: LcVectorStorePGVectorV12InsertSubnodeConfig };
};