...
export interface LcVectorStoreMilvusV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreMilvusV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMilvus';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMilvusV12RetrieveAsToolParams> & { subnodes: LcVectorStoreMilvusV12RetrieveAsToolSubnodeConfig };
};