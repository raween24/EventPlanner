...
export type LcVectorStoreWeaviateV12InsertParams = {
  mode: 'insert';
...
export interface LcVectorStoreWeaviateV12InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreWeaviateV12InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV12InsertParams> & { subnodes: LcVectorStoreWeaviateV12InsertSubnodeConfig };
};