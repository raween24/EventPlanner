...
export type LcVectorStoreQdrantV12RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreQdrantV12RetrieveSubnodeConfig {
...
export type LcVectorStoreQdrantV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV12RetrieveParams> & { subnodes: LcVectorStoreQdrantV12RetrieveSubnodeConfig };
};