...
export type LcOpenAiV18AudioGenerateParams = {
  resource: 'audio';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV18AudioGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV18AudioGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.8;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV18AudioGenerateParams> & { subnodes?: LcOpenAiV18AudioGenerateSubnodeConfig };
};