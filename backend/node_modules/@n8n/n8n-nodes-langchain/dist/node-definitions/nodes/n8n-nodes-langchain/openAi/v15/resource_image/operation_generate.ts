...
export type LcOpenAiV15ImageGenerateParams = {
  resource: 'image';
  operation: 'generate';
/**
...
export interface LcOpenAiV15ImageGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15ImageGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15ImageGenerateParams> & { subnodes?: LcOpenAiV15ImageGenerateSubnodeConfig };
};