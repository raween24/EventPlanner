...
export type LcVectorStorePGVectorV11RetrieveAsToolParams = {
...
export interface LcVectorStorePGVectorV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStorePGVectorV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV11RetrieveAsToolParams> & { subnodes: LcVectorStorePGVectorV11RetrieveAsToolSubnodeConfig };
};