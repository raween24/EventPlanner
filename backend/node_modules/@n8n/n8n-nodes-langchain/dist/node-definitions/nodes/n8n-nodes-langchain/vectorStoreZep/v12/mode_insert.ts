...
export type LcVectorStoreZepV12InsertParams = {
  mode: 'insert';
...
export interface LcVectorStoreZepV12InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreZepV12InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV12InsertParams> & { subnodes: LcVectorStoreZepV12InsertSubnodeConfig };
};