...
export type LcVectorStoreSupabaseV11RetrieveAsToolParams = {
...
export interface LcVectorStoreSupabaseV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreSupabaseV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreSupabase';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreSupabaseV11RetrieveAsToolParams> & { subnodes: LcVectorStoreSupabaseV11RetrieveAsToolSubnodeConfig };
};