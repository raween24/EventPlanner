...
export type LcOpenAiV14AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV14AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14AudioTranscribeParams> & { subnodes?: LcOpenAiV14AudioTranscribeSubnodeConfig };
};