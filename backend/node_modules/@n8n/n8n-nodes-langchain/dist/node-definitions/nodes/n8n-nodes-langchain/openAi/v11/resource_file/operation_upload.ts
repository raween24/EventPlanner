...
export type LcOpenAiV11FileUploadParams = {
  resource: 'file';
  operation: 'upload';
/**
...
export interface LcOpenAiV11FileUploadSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV11FileUploadNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV11FileUploadParams> & { subnodes?: LcOpenAiV11FileUploadSubnodeConfig };
};