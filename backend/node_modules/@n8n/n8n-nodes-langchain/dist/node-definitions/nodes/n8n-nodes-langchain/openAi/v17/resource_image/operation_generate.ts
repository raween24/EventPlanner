...
export type LcOpenAiV17ImageGenerateParams = {
  resource: 'image';
  operation: 'generate';
/**
...
export interface LcOpenAiV17ImageGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17ImageGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17ImageGenerateParams> & { subnodes?: LcOpenAiV17ImageGenerateSubnodeConfig };
};