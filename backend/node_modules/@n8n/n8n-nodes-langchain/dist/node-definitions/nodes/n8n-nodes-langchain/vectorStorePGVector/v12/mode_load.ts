...
export type LcVectorStorePGVectorV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStorePGVectorV12LoadSubnodeConfig {
...
export type LcVectorStorePGVectorV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV12LoadParams> & { subnodes: LcVectorStorePGVectorV12LoadSubnodeConfig };
};