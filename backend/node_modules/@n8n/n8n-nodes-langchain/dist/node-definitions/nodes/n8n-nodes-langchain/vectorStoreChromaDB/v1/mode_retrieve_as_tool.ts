...
export interface LcVectorStoreChromaDBV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreChromaDBV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreChromaDB';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreChromaDBV1RetrieveAsToolParams> & { subnodes: LcVectorStoreChromaDBV1RetrieveAsToolSubnodeConfig };
};