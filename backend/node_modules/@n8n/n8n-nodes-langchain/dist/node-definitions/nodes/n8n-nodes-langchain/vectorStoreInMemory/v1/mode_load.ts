...
export type LcVectorStoreInMemoryV1LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreInMemoryV1LoadSubnodeConfig {
...
export type LcVectorStoreInMemoryV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreInMemory';
  version: 1;
  config: NodeConfig<LcVectorStoreInMemoryV1LoadParams> & { subnodes: LcVectorStoreInMemoryV1LoadSubnodeConfig };
};