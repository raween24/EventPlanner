...
export type LcOpenAiV14FileUploadParams = {
  resource: 'file';
  operation: 'upload';
/**
...
export interface LcOpenAiV14FileUploadSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14FileUploadNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14FileUploadParams> & { subnodes?: LcOpenAiV14FileUploadSubnodeConfig };
};