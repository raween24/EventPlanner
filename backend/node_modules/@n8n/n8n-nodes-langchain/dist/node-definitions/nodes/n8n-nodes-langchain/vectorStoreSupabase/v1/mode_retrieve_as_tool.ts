...
export type LcVectorStoreSupabaseV1RetrieveAsToolParams = {
...
export interface LcVectorStoreSupabaseV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreSupabaseV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreSupabase';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreSupabaseV1RetrieveAsToolParams> & { subnodes: LcVectorStoreSupabaseV1RetrieveAsToolSubnodeConfig };
};