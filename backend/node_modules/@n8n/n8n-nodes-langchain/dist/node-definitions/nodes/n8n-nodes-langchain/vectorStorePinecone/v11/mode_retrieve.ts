...
export type LcVectorStorePineconeV11RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStorePineconeV11RetrieveSubnodeConfig {
...
export type LcVectorStorePineconeV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV11RetrieveParams> & { subnodes: LcVectorStorePineconeV11RetrieveSubnodeConfig };
};