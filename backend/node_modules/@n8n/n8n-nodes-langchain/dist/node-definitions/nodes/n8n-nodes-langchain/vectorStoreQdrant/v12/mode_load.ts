...
export type LcVectorStoreQdrantV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreQdrantV12LoadSubnodeConfig {
...
export type LcVectorStoreQdrantV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV12LoadParams> & { subnodes: LcVectorStoreQdrantV12LoadSubnodeConfig };
};