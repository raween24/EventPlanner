...
export type LcOpenAiV15AssistantCreateParams = {
  resource: 'assistant';
  operation: 'create';
/**
 * Model
...
export interface LcOpenAiV15AssistantCreateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15AssistantCreateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15AssistantCreateParams> & { subnodes?: LcOpenAiV15AssistantCreateSubnodeConfig };
};