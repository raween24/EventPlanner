...
export type LcVectorStoreMongoDBAtlasV11LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreMongoDBAtlasV11LoadSubnodeConfig {
...
export type LcVectorStoreMongoDBAtlasV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV11LoadParams> & { subnodes: LcVectorStoreMongoDBAtlasV11LoadSubnodeConfig };
};