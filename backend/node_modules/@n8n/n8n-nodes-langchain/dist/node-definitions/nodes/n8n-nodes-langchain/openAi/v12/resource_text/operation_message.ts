...
export type LcOpenAiV12TextMessageParams = {
  resource: 'text';
  operation: 'message';
/**
 * Model
...
export interface LcOpenAiV12TextMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV12TextMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV12TextMessageParams> & { subnodes?: LcOpenAiV12TextMessageSubnodeConfig };
};