...
export type LcOpenAiV17ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Model
...
export interface LcOpenAiV17ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17ImageAnalyzeParams> & { subnodes?: LcOpenAiV17ImageAnalyzeSubnodeConfig };
};