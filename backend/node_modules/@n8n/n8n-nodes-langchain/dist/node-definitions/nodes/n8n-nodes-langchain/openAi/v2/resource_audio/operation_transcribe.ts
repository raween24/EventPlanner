...
export type LcOpenAiV2AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV2AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV2AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV2AudioTranscribeParams> & { subnodes?: LcOpenAiV2AudioTranscribeSubnodeConfig };
};