...
export type LcOpenAiV17AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV17AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17AudioTranscribeParams> & { subnodes?: LcOpenAiV17AudioTranscribeSubnodeConfig };
};