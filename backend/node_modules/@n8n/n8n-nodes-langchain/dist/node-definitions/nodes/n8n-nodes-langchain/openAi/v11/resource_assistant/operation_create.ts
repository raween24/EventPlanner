...
export type LcOpenAiV11AssistantCreateParams = {
  resource: 'assistant';
  operation: 'create';
/**
 * Model
...
export interface LcOpenAiV11AssistantCreateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV11AssistantCreateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV11AssistantCreateParams> & { subnodes?: LcOpenAiV11AssistantCreateSubnodeConfig };
};