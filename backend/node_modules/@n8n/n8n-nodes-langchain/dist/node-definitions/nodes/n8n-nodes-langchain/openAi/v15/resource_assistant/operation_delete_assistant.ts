...
export type LcOpenAiV15AssistantDeleteAssistantParams = {
  resource: 'assistant';
...
export interface LcOpenAiV15AssistantDeleteAssistantSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15AssistantDeleteAssistantNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15AssistantDeleteAssistantParams> & { subnodes?: LcOpenAiV15AssistantDeleteAssistantSubnodeConfig };
};