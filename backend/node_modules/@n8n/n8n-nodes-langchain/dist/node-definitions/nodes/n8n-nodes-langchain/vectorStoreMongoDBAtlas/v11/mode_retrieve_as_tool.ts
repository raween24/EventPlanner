...
export type LcVectorStoreMongoDBAtlasV11RetrieveAsToolParams = {
...
export interface LcVectorStoreMongoDBAtlasV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreMongoDBAtlasV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV11RetrieveAsToolParams> & { subnodes: LcVectorStoreMongoDBAtlasV11RetrieveAsToolSubnodeConfig };
};