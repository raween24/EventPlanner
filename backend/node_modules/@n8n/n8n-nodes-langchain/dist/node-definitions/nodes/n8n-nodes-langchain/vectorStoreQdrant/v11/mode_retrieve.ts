...
export type LcVectorStoreQdrantV11RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreQdrantV11RetrieveSubnodeConfig {
...
export type LcVectorStoreQdrantV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV11RetrieveParams> & { subnodes: LcVectorStoreQdrantV11RetrieveSubnodeConfig };
};