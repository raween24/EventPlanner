...
export type LcGoogleGeminiV11VideoDownloadParams = {
  resource: 'video';
  operation: 'download';
/**
...
export interface LcGoogleGeminiV11VideoDownloadSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV11VideoDownloadNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV11VideoDownloadParams> & { subnodes?: LcGoogleGeminiV11VideoDownloadSubnodeConfig };
};