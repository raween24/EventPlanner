...
export type LcVectorStorePineconeV1LoadParams = {
  mode: 'load';
...
export interface LcVectorStorePineconeV1LoadSubnodeConfig {
...
export type LcVectorStorePineconeV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV1LoadParams> & { subnodes: LcVectorStorePineconeV1LoadSubnodeConfig };
};