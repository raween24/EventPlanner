...
export type LcOpenAiV16AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV16AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV16AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.6;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV16AudioTranscribeParams> & { subnodes?: LcOpenAiV16AudioTranscribeSubnodeConfig };
};