...
export type LcVectorStoreWeaviateV1LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreWeaviateV1LoadSubnodeConfig {
...
export type LcVectorStoreWeaviateV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV1LoadParams> & { subnodes: LcVectorStoreWeaviateV1LoadSubnodeConfig };
};