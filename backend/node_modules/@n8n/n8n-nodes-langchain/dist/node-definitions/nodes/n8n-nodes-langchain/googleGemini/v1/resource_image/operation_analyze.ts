...
export type LcGoogleGeminiV1ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Model
...
export interface LcGoogleGeminiV1ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV1ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV1ImageAnalyzeParams> & { subnodes?: LcGoogleGeminiV1ImageAnalyzeSubnodeConfig };
};