...
export type LcOpenAiV17AssistantUpdateParams = {
  resource: 'assistant';
  operation: 'update';
/**
...
export interface LcOpenAiV17AssistantUpdateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17AssistantUpdateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17AssistantUpdateParams> & { subnodes?: LcOpenAiV17AssistantUpdateSubnodeConfig };
};