...
export type LcGoogleGeminiV11FileSearchDeleteStoreParams = {
  resource: 'fileSearch';
...
export interface LcGoogleGeminiV11FileSearchDeleteStoreSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV11FileSearchDeleteStoreNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV11FileSearchDeleteStoreParams> & { subnodes?: LcGoogleGeminiV11FileSearchDeleteStoreSubnodeConfig };
};