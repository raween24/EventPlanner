...
export type LcOpenAiV1FileUploadParams = {
  resource: 'file';
  operation: 'upload';
/**
...
export interface LcOpenAiV1FileUploadSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV1FileUploadNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV1FileUploadParams> & { subnodes?: LcOpenAiV1FileUploadSubnodeConfig };
};