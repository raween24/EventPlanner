...
export type LcVectorStoreRedisV11LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreRedisV11LoadSubnodeConfig {
...
export type LcVectorStoreRedisV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreRedis';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreRedisV11LoadParams> & { subnodes: LcVectorStoreRedisV11LoadSubnodeConfig };
};