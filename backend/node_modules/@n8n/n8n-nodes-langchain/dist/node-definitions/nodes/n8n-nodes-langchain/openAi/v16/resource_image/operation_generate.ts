...
export type LcOpenAiV16ImageGenerateParams = {
  resource: 'image';
  operation: 'generate';
/**
...
export interface LcOpenAiV16ImageGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV16ImageGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.6;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV16ImageGenerateParams> & { subnodes?: LcOpenAiV16ImageGenerateSubnodeConfig };
};