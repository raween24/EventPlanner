...
export type LcOpenAiV18ImageGenerateParams = {
  resource: 'image';
  operation: 'generate';
/**
...
export interface LcOpenAiV18ImageGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV18ImageGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.8;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV18ImageGenerateParams> & { subnodes?: LcOpenAiV18ImageGenerateSubnodeConfig };
};