...
export type LcOpenAiV15AssistantMessageParams = {
  resource: 'assistant';
  operation: 'message';
/**
...
export interface LcOpenAiV15AssistantMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15AssistantMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15AssistantMessageParams> & { subnodes?: LcOpenAiV15AssistantMessageSubnodeConfig };
};