...
export interface LcVectorStoreAzureAISearchV11LoadSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreAzureAISearchV11LoadParams> & { subnodes: LcVectorStoreAzureAISearchV11LoadSubnodeConfig };
};