...
export type LcOpenAiV13AssistantUpdateParams = {
  resource: 'assistant';
  operation: 'update';
/**
...
export interface LcOpenAiV13AssistantUpdateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV13AssistantUpdateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.3;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV13AssistantUpdateParams> & { subnodes?: LcOpenAiV13AssistantUpdateSubnodeConfig };
};