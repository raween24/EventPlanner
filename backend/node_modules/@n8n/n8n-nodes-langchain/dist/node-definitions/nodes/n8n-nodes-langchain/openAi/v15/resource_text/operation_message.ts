...
export type LcOpenAiV15TextMessageParams = {
  resource: 'text';
  operation: 'message';
/**
 * Model
...
export interface LcOpenAiV15TextMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15TextMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15TextMessageParams> & { subnodes?: LcOpenAiV15TextMessageSubnodeConfig };
};