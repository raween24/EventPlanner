...
export type LcVectorStoreZepV1LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreZepV1LoadSubnodeConfig {
...
export type LcVectorStoreZepV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV1LoadParams> & { subnodes: LcVectorStoreZepV1LoadSubnodeConfig };
};