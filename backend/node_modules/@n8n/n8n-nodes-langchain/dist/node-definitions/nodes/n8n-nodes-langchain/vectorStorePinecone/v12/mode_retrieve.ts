...
export type LcVectorStorePineconeV12RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStorePineconeV12RetrieveSubnodeConfig {
...
export type LcVectorStorePineconeV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV12RetrieveParams> & { subnodes: LcVectorStorePineconeV12RetrieveSubnodeConfig };
};