...
export type LcOpenAiV14AssistantUpdateParams = {
  resource: 'assistant';
  operation: 'update';
/**
...
export interface LcOpenAiV14AssistantUpdateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14AssistantUpdateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14AssistantUpdateParams> & { subnodes?: LcOpenAiV14AssistantUpdateSubnodeConfig };
};