...
export type LcVectorStoreSupabaseV11RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreSupabaseV11RetrieveSubnodeConfig {
...
export type LcVectorStoreSupabaseV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreSupabase';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreSupabaseV11RetrieveParams> & { subnodes: LcVectorStoreSupabaseV11RetrieveSubnodeConfig };
};