...
export type LcVectorStoreZepV1RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreZepV1RetrieveSubnodeConfig {
...
export type LcVectorStoreZepV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV1RetrieveParams> & { subnodes: LcVectorStoreZepV1RetrieveSubnodeConfig };
};