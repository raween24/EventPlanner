...
export type LcOpenAiV12AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV12AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV12AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV12AudioTranscribeParams> & { subnodes?: LcOpenAiV12AudioTranscribeSubnodeConfig };
};