...
export type LcOpenAiV21AudioGenerateParams = {
  resource: 'audio';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV21AudioGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV21AudioGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV21AudioGenerateParams> & { subnodes?: LcOpenAiV21AudioGenerateSubnodeConfig };
};