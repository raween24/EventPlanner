...
export type LcGoogleGeminiV11ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Model
...
export interface LcGoogleGeminiV11ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV11ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV11ImageAnalyzeParams> & { subnodes?: LcGoogleGeminiV11ImageAnalyzeSubnodeConfig };
};