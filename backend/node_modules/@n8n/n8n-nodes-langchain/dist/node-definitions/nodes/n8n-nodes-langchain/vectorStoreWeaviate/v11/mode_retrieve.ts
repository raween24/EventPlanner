...
export type LcVectorStoreWeaviateV11RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreWeaviateV11RetrieveSubnodeConfig {
...
export type LcVectorStoreWeaviateV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV11RetrieveParams> & { subnodes: LcVectorStoreWeaviateV11RetrieveSubnodeConfig };
};