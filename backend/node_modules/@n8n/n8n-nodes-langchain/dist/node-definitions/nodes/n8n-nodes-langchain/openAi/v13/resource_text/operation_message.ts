...
export type LcOpenAiV13TextMessageParams = {
  resource: 'text';
  operation: 'message';
/**
 * Model
...
export interface LcOpenAiV13TextMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV13TextMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.3;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV13TextMessageParams> & { subnodes?: LcOpenAiV13TextMessageSubnodeConfig };
};