...
export type LcVectorStoreRedisV11RetrieveAsToolParams = {
...
export interface LcVectorStoreRedisV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreRedisV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreRedis';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreRedisV11RetrieveAsToolParams> & { subnodes: LcVectorStoreRedisV11RetrieveAsToolSubnodeConfig };
};