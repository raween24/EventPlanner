...
export type LcOpenAiV14AssistantMessageParams = {
  resource: 'assistant';
  operation: 'message';
/**
...
export interface LcOpenAiV14AssistantMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14AssistantMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14AssistantMessageParams> & { subnodes?: LcOpenAiV14AssistantMessageSubnodeConfig };
};