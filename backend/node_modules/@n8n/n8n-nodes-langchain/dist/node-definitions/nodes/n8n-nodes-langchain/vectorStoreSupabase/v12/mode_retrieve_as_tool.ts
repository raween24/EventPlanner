...
export type LcVectorStoreSupabaseV12RetrieveAsToolParams = {
...
export interface LcVectorStoreSupabaseV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreSupabaseV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreSupabase';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreSupabaseV12RetrieveAsToolParams> & { subnodes: LcVectorStoreSupabaseV12RetrieveAsToolSubnodeConfig };
};