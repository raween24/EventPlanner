...
export type LcOpenAiV17AssistantMessageParams = {
  resource: 'assistant';
  operation: 'message';
/**
...
export interface LcOpenAiV17AssistantMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17AssistantMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17AssistantMessageParams> & { subnodes?: LcOpenAiV17AssistantMessageSubnodeConfig };
};