...
export interface LcVectorStoreChromaDBV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreChromaDBV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreChromaDB';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreChromaDBV11RetrieveAsToolParams> & { subnodes: LcVectorStoreChromaDBV11RetrieveAsToolSubnodeConfig };
};