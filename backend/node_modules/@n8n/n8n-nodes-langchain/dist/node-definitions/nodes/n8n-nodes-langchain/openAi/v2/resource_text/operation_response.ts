...
export type LcOpenAiV2TextResponseParams = {
  resource: 'text';
  operation: 'response';
/**
 * Model
...
export interface LcOpenAiV2TextResponseSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV2TextResponseNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV2TextResponseParams> & { subnodes?: LcOpenAiV2TextResponseSubnodeConfig };
};