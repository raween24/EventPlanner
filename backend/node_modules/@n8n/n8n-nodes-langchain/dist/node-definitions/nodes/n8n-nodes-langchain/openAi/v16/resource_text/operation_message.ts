...
export type LcOpenAiV16TextMessageParams = {
  resource: 'text';
  operation: 'message';
/**
 * Model
...
export interface LcOpenAiV16TextMessageSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV16TextMessageNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.6;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV16TextMessageParams> & { subnodes?: LcOpenAiV16TextMessageSubnodeConfig };
};