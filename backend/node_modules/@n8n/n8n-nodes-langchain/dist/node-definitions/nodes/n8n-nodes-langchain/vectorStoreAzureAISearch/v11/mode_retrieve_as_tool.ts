...
export interface LcVectorStoreAzureAISearchV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreAzureAISearchV11RetrieveAsToolParams> & { subnodes: LcVectorStoreAzureAISearchV11RetrieveAsToolSubnodeConfig };
};