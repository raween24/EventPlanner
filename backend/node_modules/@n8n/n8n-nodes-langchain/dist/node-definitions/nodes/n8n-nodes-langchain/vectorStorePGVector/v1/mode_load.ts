...
export type LcVectorStorePGVectorV1LoadParams = {
  mode: 'load';
...
export interface LcVectorStorePGVectorV1LoadSubnodeConfig {
...
export type LcVectorStorePGVectorV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV1LoadParams> & { subnodes: LcVectorStorePGVectorV1LoadSubnodeConfig };
};