...
export type LcVectorStoreZepV11RetrieveAsToolParams = {
...
export interface LcVectorStoreZepV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreZepV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV11RetrieveAsToolParams> & { subnodes: LcVectorStoreZepV11RetrieveAsToolSubnodeConfig };
};