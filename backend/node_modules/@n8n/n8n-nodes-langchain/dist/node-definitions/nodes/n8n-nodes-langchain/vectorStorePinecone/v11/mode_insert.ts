...
export type LcVectorStorePineconeV11InsertParams = {
  mode: 'insert';
...
export interface LcVectorStorePineconeV11InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStorePineconeV11InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV11InsertParams> & { subnodes: LcVectorStorePineconeV11InsertSubnodeConfig };
};