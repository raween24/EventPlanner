...
export type LcOpenAiV14AssistantCreateParams = {
  resource: 'assistant';
  operation: 'create';
/**
 * Model
...
export interface LcOpenAiV14AssistantCreateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14AssistantCreateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14AssistantCreateParams> & { subnodes?: LcOpenAiV14AssistantCreateSubnodeConfig };
};