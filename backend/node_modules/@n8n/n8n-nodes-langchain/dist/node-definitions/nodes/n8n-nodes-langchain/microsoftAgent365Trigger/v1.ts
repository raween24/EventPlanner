...
export interface LcMicrosoftAgent365TriggerV1Params {
  systemPrompt?: string | Expression<string> | PlaceholderValue;
/**
 ...
 * @default []
 */
    includeTools?: Array<'mcp_CalendarTools' | 'mcp_MailTools' | 'mcp_MeServer' | 'mcp_ODSPRemoteServer' | 'mcp_SharePointListsTools' | 'mcp_TeamsServer' | 'mcp_TeamsCanaryServer' | 'mcp_WordServer'>;
  ...
  options?: {
    ...
    /** Welcome Message
     */
    welcomeMessage?: string | Expression<string> | PlaceholderValue;
  };
}
...
interface LcMicrosoftAgent365TriggerV1NodeBase {
  ...
  version: 1;
  credentials?: LcMicrosoftAgent365TriggerV1Credentials;
}

export type LcMicrosoftAgent365TriggerV1ParamsNode = LcMicrosoftAgent365TriggerV1NodeBase & {
  config: NodeConfig<LcMicrosoftAgent365TriggerV1Params> & { subnodes?: LcMicrosoftAgent365TriggerV1SubnodeConfig };
};
