...
export type LcOpenAiV15ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Model
...
export interface LcOpenAiV15ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV15ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.5;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV15ImageAnalyzeParams> & { subnodes?: LcOpenAiV15ImageAnalyzeSubnodeConfig };
};