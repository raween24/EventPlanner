...
export type LcVectorStoreWeaviateV11RetrieveAsToolParams = {
...
export interface LcVectorStoreWeaviateV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreWeaviateV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV11RetrieveAsToolParams> & { subnodes: LcVectorStoreWeaviateV11RetrieveAsToolSubnodeConfig };
};