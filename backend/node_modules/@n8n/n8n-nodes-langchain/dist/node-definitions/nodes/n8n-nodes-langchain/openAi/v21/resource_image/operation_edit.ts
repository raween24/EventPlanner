...
/** Edit an image */
export type LcOpenAiV21ImageEditParams = {
  resource: 'image';
  operation: 'edit';
/**
...
export interface LcOpenAiV21ImageEditSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV21ImageEditNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV21ImageEditParams> & { subnodes?: LcOpenAiV21ImageEditSubnodeConfig };
};