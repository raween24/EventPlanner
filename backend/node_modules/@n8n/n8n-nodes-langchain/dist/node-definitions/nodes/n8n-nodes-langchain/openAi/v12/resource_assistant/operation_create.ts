...
export type LcOpenAiV12AssistantCreateParams = {
  resource: 'assistant';
  operation: 'create';
/**
 * Model
...
export interface LcOpenAiV12AssistantCreateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV12AssistantCreateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV12AssistantCreateParams> & { subnodes?: LcOpenAiV12AssistantCreateSubnodeConfig };
};