...
export type LcOpenAiV13AudioGenerateParams = {
  resource: 'audio';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV13AudioGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV13AudioGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.3;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV13AudioGenerateParams> & { subnodes?: LcOpenAiV13AudioGenerateSubnodeConfig };
};