...
export type LcOpenAiV17AssistantDeleteAssistantParams = {
  resource: 'assistant';
...
export interface LcOpenAiV17AssistantDeleteAssistantSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17AssistantDeleteAssistantNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17AssistantDeleteAssistantParams> & { subnodes?: LcOpenAiV17AssistantDeleteAssistantSubnodeConfig };
};