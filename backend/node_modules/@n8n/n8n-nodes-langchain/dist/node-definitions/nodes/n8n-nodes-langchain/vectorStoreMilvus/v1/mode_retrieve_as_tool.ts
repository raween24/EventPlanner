...
export interface LcVectorStoreMilvusV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreMilvusV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMilvus';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMilvusV1RetrieveAsToolParams> & { subnodes: LcVectorStoreMilvusV1RetrieveAsToolSubnodeConfig };
};