...
export type LcOpenAiV14AudioTranslateParams = {
  resource: 'audio';
  operation: 'translate';
/**
...
export interface LcOpenAiV14AudioTranslateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV14AudioTranslateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.4;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV14AudioTranslateParams> & { subnodes?: LcOpenAiV14AudioTranslateSubnodeConfig };
};