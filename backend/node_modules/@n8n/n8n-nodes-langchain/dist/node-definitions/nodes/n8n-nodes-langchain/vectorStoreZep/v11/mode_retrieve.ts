...
export type LcVectorStoreZepV11RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreZepV11RetrieveSubnodeConfig {
...
export type LcVectorStoreZepV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV11RetrieveParams> & { subnodes: LcVectorStoreZepV11RetrieveSubnodeConfig };
};