...
export type LcOpenAiV1ImageGenerateParams = {
  resource: 'image';
  operation: 'generate';
/**
...
export interface LcOpenAiV1ImageGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV1ImageGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV1ImageGenerateParams> & { subnodes?: LcOpenAiV1ImageGenerateSubnodeConfig };
};