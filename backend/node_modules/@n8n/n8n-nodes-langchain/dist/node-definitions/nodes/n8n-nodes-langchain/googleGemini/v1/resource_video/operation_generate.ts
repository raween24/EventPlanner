...
export type LcGoogleGeminiV1VideoGenerateParams = {
  resource: 'video';
  operation: 'generate';
/**
 * Model
...
export interface LcGoogleGeminiV1VideoGenerateSubnodeConfig {
  tools?: ToolInstance[];
}

export type LcGoogleGeminiV1VideoGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.googleGemini';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcGoogleGeminiV1VideoGenerateParams> & { subnodes?: LcGoogleGeminiV1VideoGenerateSubnodeConfig };
};