...
export type LcOpenAiV21VideoGenerateParams = {
  resource: 'video';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV21VideoGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV21VideoGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2.1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV21VideoGenerateParams> & { subnodes?: LcOpenAiV21VideoGenerateSubnodeConfig };
};