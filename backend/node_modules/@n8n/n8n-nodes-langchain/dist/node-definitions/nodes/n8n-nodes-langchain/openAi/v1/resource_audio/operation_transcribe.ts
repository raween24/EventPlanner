...
export type LcOpenAiV1AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV1AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV1AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV1AudioTranscribeParams> & { subnodes?: LcOpenAiV1AudioTranscribeSubnodeConfig };
};