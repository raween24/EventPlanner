...
export type LcVectorStoreInMemoryV11RetrieveAsToolParams = {
...
export interface LcVectorStoreInMemoryV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreInMemoryV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreInMemory';
  version: 1.1;
  config: NodeConfig<LcVectorStoreInMemoryV11RetrieveAsToolParams> & { subnodes: LcVectorStoreInMemoryV11RetrieveAsToolSubnodeConfig };
};