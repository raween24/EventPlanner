...
export type LcVectorStorePineconeV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStorePineconeV12LoadSubnodeConfig {
...
export type LcVectorStorePineconeV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV12LoadParams> & { subnodes: LcVectorStorePineconeV12LoadSubnodeConfig };
};