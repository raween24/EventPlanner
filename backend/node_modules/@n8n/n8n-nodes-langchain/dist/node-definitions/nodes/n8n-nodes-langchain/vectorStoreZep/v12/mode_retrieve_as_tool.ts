...
export type LcVectorStoreZepV12RetrieveAsToolParams = {
...
export interface LcVectorStoreZepV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreZepV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV12RetrieveAsToolParams> & { subnodes: LcVectorStoreZepV12RetrieveAsToolSubnodeConfig };
};