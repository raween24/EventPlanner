...
export type LcVectorStorePGVectorV11InsertParams = {
  mode: 'insert';
...
export interface LcVectorStorePGVectorV11InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStorePGVectorV11InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePGVector';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePGVectorV11InsertParams> & { subnodes: LcVectorStorePGVectorV11InsertSubnodeConfig };
};