...
export interface LcVectorStoreAzureAISearchV1RetrieveSubnodeConfig {
...
export type LcVectorStoreAzureAISearchV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreAzureAISearch';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreAzureAISearchV1RetrieveParams> & { subnodes: LcVectorStoreAzureAISearchV1RetrieveSubnodeConfig };
};