...
export type LcVectorStoreZepV11LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreZepV11LoadSubnodeConfig {
...
export type LcVectorStoreZepV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV11LoadParams> & { subnodes: LcVectorStoreZepV11LoadSubnodeConfig };
};