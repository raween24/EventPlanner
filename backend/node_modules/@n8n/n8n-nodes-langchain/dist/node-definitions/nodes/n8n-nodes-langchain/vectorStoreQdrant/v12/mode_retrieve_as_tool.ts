...
export type LcVectorStoreQdrantV12RetrieveAsToolParams = {
...
export interface LcVectorStoreQdrantV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreQdrantV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV12RetrieveAsToolParams> & { subnodes: LcVectorStoreQdrantV12RetrieveAsToolSubnodeConfig };
};