...
export type LcVectorStoreQdrantV1RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreQdrantV1RetrieveSubnodeConfig {
...
export type LcVectorStoreQdrantV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreQdrant';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreQdrantV1RetrieveParams> & { subnodes: LcVectorStoreQdrantV1RetrieveSubnodeConfig };
};