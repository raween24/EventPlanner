...
export type LcOpenAiV13AudioTranscribeParams = {
  resource: 'audio';
...
export interface LcOpenAiV13AudioTranscribeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV13AudioTranscribeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.3;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV13AudioTranscribeParams> & { subnodes?: LcOpenAiV13AudioTranscribeSubnodeConfig };
};