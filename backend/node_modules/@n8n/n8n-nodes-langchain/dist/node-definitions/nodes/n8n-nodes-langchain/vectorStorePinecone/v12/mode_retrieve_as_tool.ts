...
export type LcVectorStorePineconeV12RetrieveAsToolParams = {
...
export interface LcVectorStorePineconeV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStorePineconeV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStorePinecone';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStorePineconeV12RetrieveAsToolParams> & { subnodes: LcVectorStorePineconeV12RetrieveAsToolSubnodeConfig };
};