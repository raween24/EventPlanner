...
export interface LcVectorStoreChromaDBV12LoadSubnodeConfig {
...
export type LcVectorStoreChromaDBV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreChromaDB';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreChromaDBV12LoadParams> & { subnodes: LcVectorStoreChromaDBV12LoadSubnodeConfig };
};