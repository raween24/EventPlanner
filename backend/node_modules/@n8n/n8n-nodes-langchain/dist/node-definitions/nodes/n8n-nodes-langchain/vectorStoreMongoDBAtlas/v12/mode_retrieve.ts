...
export type LcVectorStoreMongoDBAtlasV12RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreMongoDBAtlasV12RetrieveSubnodeConfig {
...
export type LcVectorStoreMongoDBAtlasV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV12RetrieveParams> & { subnodes: LcVectorStoreMongoDBAtlasV12RetrieveSubnodeConfig };
};