...
export type LcVectorStoreInMemoryV12RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreInMemoryV12RetrieveSubnodeConfig {
...
export type LcVectorStoreInMemoryV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreInMemory';
  version: 1.2;
  config: NodeConfig<LcVectorStoreInMemoryV12RetrieveParams> & { subnodes: LcVectorStoreInMemoryV12RetrieveSubnodeConfig };
};