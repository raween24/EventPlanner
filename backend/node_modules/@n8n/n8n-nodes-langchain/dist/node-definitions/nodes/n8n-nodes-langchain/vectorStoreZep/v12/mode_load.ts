...
export type LcVectorStoreZepV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreZepV12LoadSubnodeConfig {
...
export type LcVectorStoreZepV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreZep';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreZepV12LoadParams> & { subnodes: LcVectorStoreZepV12LoadSubnodeConfig };
};