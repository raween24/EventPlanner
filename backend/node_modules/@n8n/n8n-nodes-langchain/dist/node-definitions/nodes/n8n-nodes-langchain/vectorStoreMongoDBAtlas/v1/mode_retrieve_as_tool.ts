...
export interface LcVectorStoreMongoDBAtlasV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreMongoDBAtlasV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV1RetrieveAsToolParams> & { subnodes: LcVectorStoreMongoDBAtlasV1RetrieveAsToolSubnodeConfig };
};