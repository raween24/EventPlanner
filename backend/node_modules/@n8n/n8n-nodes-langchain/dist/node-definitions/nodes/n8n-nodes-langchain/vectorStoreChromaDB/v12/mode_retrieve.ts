...
export interface LcVectorStoreChromaDBV12RetrieveSubnodeConfig {
...
export type LcVectorStoreChromaDBV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreChromaDB';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreChromaDBV12RetrieveParams> & { subnodes: LcVectorStoreChromaDBV12RetrieveSubnodeConfig };
};