...
export type LcVectorStoreWeaviateV12RetrieveAsToolParams = {
...
export interface LcVectorStoreWeaviateV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreWeaviateV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreWeaviate';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreWeaviateV12RetrieveAsToolParams> & { subnodes: LcVectorStoreWeaviateV12RetrieveAsToolSubnodeConfig };
};