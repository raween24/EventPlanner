...
export type LcOpenAiV17FileUploadParams = {
  resource: 'file';
  operation: 'upload';
/**
...
export interface LcOpenAiV17FileUploadSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17FileUploadNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17FileUploadParams> & { subnodes?: LcOpenAiV17FileUploadSubnodeConfig };
};