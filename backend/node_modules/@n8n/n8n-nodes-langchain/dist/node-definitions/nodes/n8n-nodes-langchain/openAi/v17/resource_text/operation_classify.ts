...
export type LcOpenAiV17TextClassifyParams = {
  resource: 'text';
  operation: 'classify';
/**
...
export interface LcOpenAiV17TextClassifySubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV17TextClassifyNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1.7;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV17TextClassifyParams> & { subnodes?: LcOpenAiV17TextClassifySubnodeConfig };
};