...
export type LcVectorStoreMongoDBAtlasV12LoadParams = {
  mode: 'load';
...
export interface LcVectorStoreMongoDBAtlasV12LoadSubnodeConfig {
...
export type LcVectorStoreMongoDBAtlasV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreMongoDBAtlas';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV12LoadParams> & { subnodes: LcVectorStoreMongoDBAtlasV12LoadSubnodeConfig };
};