...
export type LcVectorStoreRedisV1RetrieveParams = {
  mode: 'retrieve';
...
export interface LcVectorStoreRedisV1RetrieveSubnodeConfig {
...
export type LcVectorStoreRedisV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreRedis';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreRedisV1RetrieveParams> & { subnodes: LcVectorStoreRedisV1RetrieveSubnodeConfig };
};