...
export type LcVectorStoreRedisV12InsertParams = {
  mode: 'insert';
...
export interface LcVectorStoreRedisV12InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreRedisV12InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreRedis';
  version: 1.2;
  credentials?: Credentials;
  config: NodeConfig<LcVectorStoreRedisV12InsertParams> & { subnodes: LcVectorStoreRedisV12InsertSubnodeConfig };
};