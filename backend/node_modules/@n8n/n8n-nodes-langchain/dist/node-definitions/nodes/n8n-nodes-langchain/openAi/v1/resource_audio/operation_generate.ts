...
export type LcOpenAiV1AudioGenerateParams = {
  resource: 'audio';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV1AudioGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV1AudioGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<LcOpenAiV1AudioGenerateParams> & { subnodes?: LcOpenAiV1AudioGenerateSubnodeConfig };
};