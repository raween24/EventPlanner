...
export declare class ExecutionRepository extends Repository<ExecutionEntity> {
    ...
    deleteExecutionsByFilter({ filters, accessibleWorkflowIds, deleteConditions, }: ExecutionDeletionCriteria): Promise<Array<{
        executionId: string;
        workflowId: string;
    ...
    findIfSharedUnflatten(executionId: string, sharedWorkflowIds: string[]): Promise<IExecutionResponse | undefined>;
    ...
    findByStopExecutionsFilter(query: ExecutionSummaries.StopExecutionFilterQuery): Promise<Array<{
        id: string;
    }>>;
}
