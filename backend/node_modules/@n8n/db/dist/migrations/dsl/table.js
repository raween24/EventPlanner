...
class CreateTable extends TableOperation {
    ...
    async execute(queryRunner) {
        ...
        const { columns, tableName: name, prefix, indices, uniqueConstraints, foreignKeys, checks, } = this;
...
class AddColumns extends TableOperation {
    ...
    async execute(queryRunner) {
        ...
        await queryRunner.addColumns(fullTableName, columns.map((c) => new typeorm_1.TableColumn(c.toOptions(driver))));
