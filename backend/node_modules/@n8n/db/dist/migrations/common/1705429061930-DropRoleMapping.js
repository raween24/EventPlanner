...
class DropRoleMapping1705429061930 {
    ...
    async migrateUp(table, { escape, runQuery, schemaBuilder: { addNotNull, addColumns, dropColumns, dropForeignKey, column }, tablePrefix, }) {
    ...
    async migrateDown(table, { escape, runQuery, schemaBuilder: { addNotNull, addColumns, dropColumns, addForeignKey, column }, tablePrefix, }) {
        const roleColumnName = table === 'user' ? 'globalRoleId' : 'roleId';
