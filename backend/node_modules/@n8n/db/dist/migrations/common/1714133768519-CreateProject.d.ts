...
export declare class CreateProject1714133768519 implements ReversibleMigration {
    ...
    alterSharedTable(relationTableName: RelationTable, { escape, runQuery, schemaBuilder: { addForeignKey, addColumns, addNotNull, createIndex, column }, }: MigrationContext): Promise<void>;
    ...
    down({ logger, escape, runQuery, schemaBuilder: sb }: MigrationContext): Promise<void>;
}
export {};
